namespace RmsPM.BLL.CommomWorkFlowBLL
{
    ...
    public class InquirePriceBFL
    {
        public int Delete(InquirePriceModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new InquirePriceBLL().Delete(ObjModel.InquirePriceCode, transaction);
                        transaction.Commit();
                    }
        ...
        public List<InquirePriceModel> GetInquirePriceList(InquirePriceQueryModel QueryModel)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                try
                {
                    ...
                    if (QueryModel == null)
                    {
                        QueryModel = new InquirePriceQueryModel();
                    }
                    models = new InquirePriceBLL().GetModels(QueryModel, connection);
                    connection.Close();
                }
                catch (SqlException exception)
                {
        ...
        public int Insert(InquirePriceModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new InquirePriceBLL().Insert(ObjModel, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyAlreadyAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new InquirePriceBLL().ModifyAlreadyAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyNotAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new InquirePriceBLL().ModifyNotAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyNotPassAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new InquirePriceBLL().ModifyNotPassAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int Update(InquirePriceModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new InquirePriceBLL().Update(ObjModel, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
