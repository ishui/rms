...
<tr style="display:none" id='TreeNode_<%# DataBinder.Eval(Container, "DataItem.CostBudgetDtlCode") %>' key='<%# DataBinder.Eval(Container, "DataItem.CostBudgetDtlCode") %>' Deep='<%# DataBinder.Eval(Container, "DataItem.Deep") %>' ParentCode='<%# DataBinder.Eval(Container, "DataItem.ParentCode") %>' ChildCount='<%# DataBinder.Eval(Container, "DataItem.ChildCount") %>' RowIndex='<%# Container.ItemIndex %>' DefaultExpand='<%# DataBinder.Eval(Container, "DataItem.IsExpand") %>'
	BalanceContractMoney='<%# RmsPM.BLL.ConvertRule.ToDecimal(DataBinder.Eval(Container, "DataItem.BalanceContractMoney")) %>' CostCode='<%# DataBinder.Eval(Container, "DataItem.CostCode") %>' onclick="RowClick(this);" onmouseup="RowMouseClick(this);">
...
<%# RmsPM.BLL.CostBudgetPageRule.GetTd(DataBinder.Eval(Container, "DataItem.ContractIDHtml"), DataBinder.Eval(Container, "DataItem.ClassTd"))%>
<%# RmsPM.BLL.CostBudgetPageRule.GetTd(DataBinder.Eval(Container, "DataItem.ContractNameHtml"), DataBinder.Eval(Container, "DataItem.ClassTd"))%>
<%# RmsPM.BLL.CostBudgetPageRule.GetTd(DataBinder.Eval(Container, "DataItem.SupplierNameHtml"), DataBinder.Eval(Container, "DataItem.ClassTd"))%>
<%# RmsPM.BLL.CostBudgetPageRule.GetTd(DataBinder.Eval(Container, "DataItem.DescriptionHtml"), RmsPM.BLL.CostBudgetDynamic.GetChangeDescShowHtml(ViewState["HasTargetChange"], DataBinder.Eval(Container, "DataItem.Description"), DataBinder.Eval(Container, "DataItem.BudgetChangeDescription"), DataBinder.Eval(Container, "DataItem.BudgetChangeDescription")), DataBinder.Eval(Container, "DataItem.ClassTd"))%>
<%# DataBinder.Eval(Container, "DataItem.PlanDataHtml") %>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' title='<%# GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.BudgetMoney")) %><%# RmsPM.BLL.CostBudgetDynamic.GetChangeMoneyShowHtml(ViewState["HasTargetChange"], DataBinder.Eval(Container, "DataItem.BudgetMoney"), DataBinder.Eval(Container, "DataItem.BudgetChangeMoney"), GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.BudgetChangeMoney")), DataBinder.Eval(Container, "DataItem.RecordType")) %>'>
...
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.ContractMoney"))) %>>
<%# GetMoneyShowString(DataBinder.Eval(Container, "DataItem.ContractMoney")) %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.ContractChangeMoney"))) %>>
<%# GetMoneyShowString(DataBinder.Eval(Container, "DataItem.ContractChangeMoney")) %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.ContractApplyMoney"))) %>>
<%# GetMoneyShowString(DataBinder.Eval(Container, "DataItem.ContractApplyMoney")) %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.ContractTotalMoney"))) %>>
<%# GetMoneyShowString(DataBinder.Eval(Container, "DataItem.ContractTotalMoney")) %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.ContractBudgetBalance"))) %>>
<%# GetMoneyShowString(DataBinder.Eval(Container, "DataItem.ContractBudgetBalance")) %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.BuildingPrice"))) %>>
<%# GetMoneyShowString(DataBinder.Eval(Container, "DataItem.BuildingPrice"), "price") %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.HousePrice"))) %>>
<%# GetMoneyShowString(DataBinder.Eval(Container, "DataItem.HousePrice"), "price") %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.ContractPay"))) %>>
...
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r'>
<%# RmsPM.BLL.StringRule.BuildShowPercentString(DataBinder.Eval(Container, "DataItem.ContractPayPercent"), "####") %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.ContractPayBalance"))) %>>
<%# GetMoneyShowString(DataBinder.Eval(Container, "DataItem.ContractPayBalance")) %>
</td>
<td class='<%# DataBinder.Eval(Container, "DataItem.ClassTd") %>-r' <%# RmsPM.BLL.CostBudgetPageRule.GetTitle(GetMoneyShowHint(DataBinder.Eval(Container, "DataItem.ContractPayReal"))) %>>
