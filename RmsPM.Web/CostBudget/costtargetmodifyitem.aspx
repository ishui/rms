<%@ Page language="c#" Inherits="RmsPM.Web.CostBudget.CostTargetModifyItem" CodeFile="CostTargetModifyItem.aspx.cs" %>
	...
	<body scroll="no">
		<form id="Form1" method="post" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="#ffffff">
				<tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">修改目标费用</td>
				</tr>
				<tr height="100%">
