<%@ Page language="c#" Inherits="RmsPM.Web.SelectBox.SelectStationPersonIncludeS" CodeFile="SelectStationPersonIncludeS.aspx.cs" %>
	...
	var node = obj;
		...
		if(noneNode.style.display!=""){
			...
			/*----------------------------------和SelectStationPerson不同处 begin------------------------------------------*/
				...
				//取部门的子部门
//				GetChildNodes(DataSourceUrl+"&GetType=ChildNodesOnlyUnit&NodeId="+UnitCode + "&ParentLayer=" + LayerNumber,node,TreeModels,"Code",RowClassName,GridClassName);
