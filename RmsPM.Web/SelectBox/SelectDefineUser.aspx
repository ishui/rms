<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectDefineUser.aspx.cs"
    Inherits="RmsPM.Web.SelectBox.SelectDefineUser" %>
...
<body style="margin: 0 0 0 0;" onload="winload()">
                    ...
                    <div style="overflow: auto; width: 100%; height: 100%">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="list">
                            <tr class="list-title">
                                ...
                                <td style="width: 60px;">
                                    <input type="checkbox" id="chkAll" onclick="selectAllCheck();" title="全选" /></td>
                                <td>
                                    人员</td>
                            </tr>
                            <asp:Repeater ID="repeaterSU" runat="server">
                                <ItemTemplate>
                                    <tr style="width:100%;">
                                        ...
                                        <td>
                                            <input type="checkbox" id="chk" NameTemp='<%# DataBinder.Eval( Container,"DataItem.Name" )%>'
                                                RelationCode='<%# DataBinder.Eval( Container,"DataItem.RelationCode" )%>' AccessRangeType='<%# DataBinder.Eval( Container,"DataItem.AccessRangeType" )%>'
                                                UnitFullName=''></td>
                                        <td width="100%">
            ...
            <tr style="display: none">
                <td>
                    <table cellspacing="0" cellpadding="10" width="100%" border="0" id="tableButton"
                        ...
                        <tr align="center">
                            <td>
                                <input class="submit" id="btnSelect" type="button" value="选 择" name="btnSelect" onclick="doSelectSU();" />
                            </td>
                        </tr>
                    </table>
                </td>
