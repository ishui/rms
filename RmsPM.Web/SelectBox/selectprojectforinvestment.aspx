								...
								<td>
									<table>
										<TR>
											...
											<td>&nbsp;<INPUT class="submit" id="Button1" type="button" value="新 增" name="btnSearch" runat="server"></td>
										</TR>
									</table>
								</td>
							</tr>
								...
								<td width="100%">
									<div style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 100%"><asp:datagrid id="dgList" runat="server" CssClass="list" Width="100%" AllowSorting="True" AutoGenerateColumns="False"
											...
											<Columns>
												...
												<asp:TemplateColumn Visible="False" SortExpression="ProjectName" HeaderText="项目名称">
													<HeaderStyle Wrap="False" HorizontalAlign="Left"></HeaderStyle>
													<ItemTemplate>
														<%# DataBinder.Eval(Container, "DataItem.ProjectName") %>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn SortExpression="ProjectName" HeaderText="项目名称">
													<HeaderStyle Wrap="False" HorizontalAlign="Left"></HeaderStyle>
													<ItemTemplate>
												...
												<asp:BoundColumn Visible="False" DataField="kgDate" SortExpression="kgDate" HeaderText="开期" DataFormatString="{0:yyyy/MM}"></asp:BoundColumn>
												<asp:BoundColumn Visible="False" DataField="jgDate" SortExpression="jgDate" HeaderText="竣期" DataFormatString="{0:yyyy/MM}"></asp:BoundColumn>
												<asp:BoundColumn HeaderText="城市"></asp:BoundColumn>
											</Columns>
										...
										<tr>
											<td colSpan="2">
												<div style="OVERFLOW: auto; WIDTH: 250px; HEIGHT: 100%"><asp:datagrid id="dgListAdd" runat="server" CssClass="list" Width="100%" AllowSorting="False"
														...
														<PagerStyle NextPageText="下一页&lt;img src='../images/page_next.gif' width=9 height=9 border=0 &gt;"
															PrevPageText="&lt;img src='../images/page_pre.gif' width=9 height=9 border=0&gt;上一页" HorizontalAlign="Right"
															CssClass="ListHeadTr"></PagerStyle>
													</asp:datagrid></div>
											</td>
										</tr>
						...
						<table cellSpacing="10" width="100%">
							<tr>
								<td align="center"><input class="submit" id="btnClear" style="DISPLAY: none" onclick="DoSelectProject('', '');"
										type="button" value="清 除" name="btnClear" runat="server"> <input class="submit" id="btnClose" onclick="javascript:self.close()" type="button" value="取 消"
										name="btnClose">
								</td>
							</tr>
						</table>
						...
						<table cellSpacing="10" width="100%">
							<tr>
								<td align="center"><input class="submit" id="btnAdd" onclick="if (!btnAddClick()) return false;" type="button"
										value="添 加" name="btnAdd" runat="server" onserverclick="btnAdd_ServerClick"> <input class="submit" id="btnOK" onclick="btnOKClick();" type="button" value="确 定" name="btnOK"
										runat="server"> <input class="submit" id="btnCancel" onclick="javascript:self.close()" type="button" value="取 消"
										name="btnCancel">
								</td>
							</tr>
						</table>
