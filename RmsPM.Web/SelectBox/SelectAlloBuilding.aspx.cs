...
{
	/// <summary>
	/// SelectAlloBuilding 的摘要说明。
	/// </summary>
	public partial class SelectAlloBuilding : PageBase
	{
		...
		private void IniPage()
		{
			...
			this.txtAlloType.Value = Request["AlloType"];
...
//			this.txtInputName.Value = Request["SelectName"];
			...
			if (this.txtAlloType.Value == "") 
			{
				this.txtAlloType.Value = "P";
			}
			this.rdoType.SelectedValue = this.txtAlloType.Value;
		}
		...
		protected void btnSave_ServerClick(object sender, System.EventArgs e)
		{
			...
			Response.Write("window.opener." + this.txtReturnFunc.Value + "('" + this.rdoType.SelectedValue + "', '" + this.txtOutputCode.Value + "', '" + this.txtOutputName.Value + "');");
