<%@ Page language="c#" Inherits="RmsPM.Web.SelectBox.SelectAlloBuilding" CodeFile="SelectAlloBuilding.aspx.cs" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="winload();" rightMargin="0"
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="#ffffff">
				<tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">选择分摊</td>
				</tr>
				<tr>
					<td>
						<table class="form" cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td><asp:RadioButtonList Runat="server" ID="rdoType" RepeatColumns="3" onclick="TypeClick();">
										<asp:ListItem Selected="True" Value="P">项目</asp:ListItem>
			...
			<input type="hidden" id="txtAlloType" name="txtAlloType" runat="server">
		</form>
		<SCRIPT language="javascript">
function TypeClick()
{
	...
	if (Form1.rdoType[1].checked)
	{
		...
		document.all.frameMain.src = "../SelectBox/SelectBuildingByPBSUnit.aspx?ProjectCode=" + Form1.txtProjectCode.value + "&act=pbsunit&SelectCode=" + Form1.txtInputCode.value;
	}

	if (Form1.rdoType[2].checked)
	{
		document.all.trBtn.style.display = "none";
		document.all.frameMain.src = "../SelectBox/SelectBuildingByPBSUnit.aspx?ProjectCode=" + Form1.txtProjectCode.value + "&act=building&SelectCode=" + Form1.txtInputCode.value;
	}
}
...
{
	TypeClick();
//	var AlloType = Form1.txtAlloType.value.toUpperCase();
}
