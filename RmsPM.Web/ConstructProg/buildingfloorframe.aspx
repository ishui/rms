<%@ Page language="c#" Inherits="RmsPM.Web.ConstructProg.BuildingFloorFrame" CodeFile="BuildingFloorFrame.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BuildingFloorFrame</title>
...
function winload()
{
	...
	objLeft.src = '../PBS/SelectBuildingWindow.aspx?ProjectCode=' + Form1.txtProjectCode.value + '&BuildingCode=' + Form1.txtBuildingCode.value;
...
function GotoBuilding(BuildingCode)
{
	...
	if (BuildingCode != "")
	{
		objFrame.src = '../ConstructProg/BuildingFloorInfo.aspx?BuildingCode=' + BuildingCode + '&DefaultVisualProgress=' + Form1.txtDefaultVisualProgress.value;
	}
	else
	{
		objFrame.src = '';
