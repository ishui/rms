<%@ Page language="c#" Inherits="RmsPM.Web.ConstructProg.ProjectProgressChartInfraGantt" CodeFile="ProjectProgressChartInfraGantt.aspx.cs" %>
...
function RemoveChartColumnID(text)
{
	...
	<body style="BORDER-RIGHT: 0px" scroll="no" style="background:;border-right:0px" onload="winload();">
															...
															<td><igchart:ultrachart id="UltraChart1" runat="server" ChartType="GanttChart" Width="700px" Height="492px"
																	...
																	<ColorModel ColorBegin="LimeGreen" ColorEnd="Salmon" AlphaLevel="150" ModelStyle="CustomSkin"
																		...
																		<Skin ApplyRowWise="False">
																			<PEs>
																				<igchartprop:PaintElement FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill" Fill="Salmon" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit" FillStopColor="Transparent" StrokeOpacity="255" ImagePath="" Stroke="Black" StrokeWidth="1" ImageWrapMode="Tile" TextureApplication="Normal"></igchartprop:PaintElement>
																				<igchartprop:PaintElement FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill" Fill="LimeGreen" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit" FillStopColor="Transparent" StrokeOpacity="255" ImagePath="" Stroke="Black" StrokeWidth="1" ImageWrapMode="Tile" TextureApplication="Normal"></igchartprop:PaintElement>
																			</PEs>
																		</Skin>
																	</ColorModel>
