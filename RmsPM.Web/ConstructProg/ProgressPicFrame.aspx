<%@ Page language="c#" Inherits="RmsPM.Web.ConstructProg.ProgressPicFrame" CodeFile="ProgressPicFrame.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ProgressPicFrame</title>
...
function winload()
{
	...
	objMain.src = 'ProgressPic.aspx?ProjectCode=' + Form1.txtProjectCode.value;
}
		</SCRIPT>
	</HEAD>
