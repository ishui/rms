<%@ Page language="c#" Inherits="RmsPM.Web.ConstructProg.ProjectProgressFrame" CodeFile="ProjectProgressFrame.aspx.cs" %>
...
function winload()
{
	...
	objMain.src = '../ConstructProg/ProjectProgressInfo.aspx?ProjectCode=' + Form1.txtProjectCode.value + "&type=" + type + "&GanttType=" + GanttType;
}
		</SCRIPT>
	</HEAD>
