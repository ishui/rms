<%@ Page language="c#" Inherits="RmsPM.Web.ConstructProg.ProjectProgressChartInfraGanttA" CodeFile="ProjectProgressChartInfraGanttA.aspx.cs" %>
			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" bgColor="white">
				...
				<tr height="100%">
					<td><igchart:ultrachart id="UltraChart1" runat="server" ChartType="GanttChart" Width="700px" Height="492px"
								...
								<Skin ApplyRowWise="False">
									<PEs>
										<igchartprop:PaintElement FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill"
											Fill="188, 188, 255" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit" FillStopColor="Transparent"
							...
							<Tooltips BorderThickness="1" Overflow="ClientArea" FormatString="&lt;DATA_COLUMN&gt;@&lt;SERIES_LABEL&gt;&lt;br&gt;&lt;DATA_VALUE:00.00&gt;"
							...
							<GanttChart LinkLineColor="Black" ShowCompletePercentages="True">
								...
								<CompletePercentagesPE FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill"
									Fill="Black" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit" FillStopColor="Yellow"
