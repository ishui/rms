...
<%@ Page language="c#" Inherits="RmsPM.Web.ConstructProg.BuildingFloorProgressBatchModify" CodeFile="BuildingFloorProgressBatchModify.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>楼栋形象进度批修改</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" scroll="no" rightMargin="0" onload="winload();">
		<form id="Form1" method="post" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="white">
				<tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">楼栋形象进度批修改</td>
				</tr>
				<tr height="100%">
					<td valign="top">
						<TABLE class="form" cellSpacing="0" cellPadding="0" width="100%">
							...
							<tr>
								<TD class="form-item" noWrap>楼层范围：</TD>
								<TD colspan="3"><select class="select" id="sltBuildingFloorIndexBegin" name="sltBuildingFloorIndexBegin"
										runat="server">
										<option selected value="">全部楼层</option>
									</select>
									——&nbsp;<select class="select" id="sltBuildingFloorIndexEnd" name="sltBuildingFloorIndexEnd" runat="server">
										<option selected value="">全部楼层</option>
									</select>
								</TD>
							</tr>
							<tr>
								<TD class="form-item" noWrap>工作：</TD>
			...
			<input id="txtVisualProgressCode" type="hidden" name="txtVisualProgressCode" runat="server">
		</form>
