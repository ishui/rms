namespace RmsPM.Web.BiddingManage
{
    ...
    public partial class ControlBiddingConditionFileModigy : BiddingControlBase
    {
        ...
        private void LoadData(bool Flag)
        {
            ...
            if (this.ApplicationCode != "")
            {
                ...
                if (entitydata.HasRecord())
                {
                    ...
                    if (Flag)
                    {
                        ...
                        string LinkUrl = "<a onclick=OpenLargeWindow('../BiddingManage/biddingmodify.aspx?BiddingCode=" + this.BiddingCode + "&State=edit&ProjectCode=" + cBidding.ProjectCode + "','ControlBiddingConditionFileModigy1')>" + cBidding.Title + "</a>";
                    ...
                    else
                    {
                        RmsPM.BLL.Bidding cBidding = new RmsPM.BLL.Bidding();
                        cBidding.BiddingCode = this.BiddingCode;
                        string LinkUrl = "<a onclick=OpenLargeWindow('../BiddingManage/biddingmodify.aspx?BiddingCode=" + this.BiddingCode + "&State=edit&ProjectCode=" + cBidding.ProjectCode + "','ControlBiddingConditionFileModigy2')>" + cBidding.Title + "</a>";
                        //this.tdBiddingTitle.InnerHtml = cBidding.Title;
            ...
            else
            {
                RmsPM.BLL.Bidding cBidding = new RmsPM.BLL.Bidding();
                cBidding.BiddingCode = this.BiddingCode;
                string LinkUrl = "<a onclick=OpenLargeWindow('../BiddingManage/biddingmodify.aspx?BiddingCode=" + this.BiddingCode + "&State=edit&ProjectCode=" + cBidding.ProjectCode + "','ControlBiddingConditionFileModigy3')>" + cBidding.Title + "</a>";
                //this.tdBiddingTitle.InnerHtml = cBidding.Title;
                this.txtBiddingTitle.InnerHtml = LinkUrl;
                this.txtProjectName.InnerHtml = RmsPM.BLL.ProjectRule.GetProjectName(cBidding.ProjectCode);
            }
