<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlBiddingConditionFileModigy.ascx.cs" Inherits="RmsPM.Web.BiddingManage.ControlBiddingConditionFileModigy" %>
