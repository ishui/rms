<%@ Control Language="C#" AutoEventWireup="true" CodeFile="control_pw_rpRemind.ascx.cs" Inherits="RmsPM.Web.DeskTopControl.control_pw_rpRemind" %>
<link href="../images/index.css" type="text/css" rel="stylesheet"/>
<table id="table1" cellpadding="0" cellspacing="0" width="100%" background="images/desktop/bg.gif"
	border="0">
	<tr>
