<%@ Control Language="c#" Inherits="RmsPM.Web.DeskTopControl.Control_rpAudit" CodeFile="Control_rpAudit.ascx.cs" %>
<LINK href="../images/index.css" type="text/css" rel="stylesheet">
<table cellSpacing="0" cellPadding="0" width="100%" background="images/desktop/bg.gif"
	border="0" id="table1">
	<tr>
		<td>
			<IMG src="images/desktop/topic_mail.gif"></td>
		...
		<td vAlign="middle" width="35"><a href="./WorkFlowContral/WorkFlowReceiveBox.aspx">[È«²¿]</a></td>
		<td style="PADDING-TOP: 18px" vAlign="top" width="60"><!--<A href="#"><IMG height="17" src="images/desktop/bn_more.gif" width="60" border="0"></A>--></td>
	</tr>
</table>
<table height="88" border="0" id="table2">
	<tr>
		<td vAlign="top">
			<table class="txt" cellSpacing="0" cellPadding="0" width="300" align="center" border="0"
				valign="top" id="table3">
				<asp:repeater id="rpAudit" Runat="server">
					<ItemTemplate>
						<tr>
							<td width="20"></td>
