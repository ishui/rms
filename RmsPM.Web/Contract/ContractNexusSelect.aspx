<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractNexusSelect.aspx.cs"
    Inherits="ContractNexusSelect" %>
                ...
                <td valign="top">
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ViseEndDate" HeaderText="期限" SortExpression="ViseEndDate"
                                DataFormatString="{0:d}" HtmlEncode="False" />
                            <asp:BoundField DataField="ViseDate" HeaderText="日期" SortExpression="ViseDate" DataFormatString="{0:d}"
                                HtmlEncode="False" />
                        </Columns>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetLocalVises"
                        ...
                        <SelectParameters>
                            ...
                            <asp:Parameter Name="ViseBalanceStatusInStr" Type="String" DefaultValue="1" />
...
<script language="javascript">
	...
	{
		OpenFullWindow('../LocaleVise/LocaleViseInfo.aspx?ProjectCode=<%= Request["ProjectCode"]+"" %>&ViseCode='+Code,'现场签证');
	}
	function SelectCheckBox()
	{
		...
		for ( var i=0; i<ViseCodes.length;i++)
		{
			if(ViseCodes[i]!="")
			{
			    ...
			    {
			        SelectedViseCodes += document.all(ViseCodes[i]).value+",Vise;";
			    }
			}
		}
		parent.returnValue = SelectedViseCodes.substr(0,SelectedViseCodes.length-1);
		parent.close();
	}
