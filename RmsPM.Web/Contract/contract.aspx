...
<%@ Page language="c#" Inherits="RmsPM.Web.Contract.Contract" CodeFile="Contract.aspx.cs" %>
			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<td class="tools-area" vAlign="top">
						<IMG src="../images/btn_li.gif" align="absMiddle"> <input class="button" id="btnNew" onclick="doNewContract('');return false;" type="button"
							value="新增合同" name="btnNew" runat="server">
					</td>
				</TR>
				<tr height="100%">
											...
											<td>
												...
												<table style="DISPLAY:none" id="divAdvSearch">
													...
													<tr id="trAdIssueDate" runat="server">
													    <td>广告发布日期：<cc3:calendar id="dtAdIssueDate0" runat="server" CalendarResource="../Images/CalendarResource/"
																ReadOnly="False" Display="True" Value=""></cc3:calendar>
															——<cc3:calendar id="dtAdIssueDate1" runat="server" CalendarResource="../Images/CalendarResource/"
																ReadOnly="False" Display="True" Value=""></cc3:calendar>
													    </td>
													</tr>
													<tr>
														<td>
                                                            ...
                                                            每页显示：<INPUT class="input" id="txtPageSize" type="text" size="4" name="txtPageSize" runat="server">条记录
							...
							<tr height="100%">
								<td>
									...
									<div style="OVERFLOW:auto;WIDTH:100%;POSITION:absolute;HEIGHT:100%">
										<asp:datagrid id="dgList" runat="server" AutoGenerateColumns="False"  AllowPaging="True"
											GridLines="Horizontal" CellPadding="0" Width="100%" CssClass="list" AllowSorting="true" ShowFooter="True">
											<AlternatingItemStyle CssClass="list-i"></AlternatingItemStyle>
											<HeaderStyle CssClass="list-title"></HeaderStyle>
											<FooterStyle CssClass="list-title"></FooterStyle>
											<Columns>
												<asp:TemplateColumn SortExpression="DevelopUnit" ItemStyle-Width="160px" HeaderText="开发单位">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
													<ItemTemplate>
                                                         <%#  DataBinder.Eval(Container.DataItem, "DevelopUnit") %>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn SortExpression="ContractName" ItemStyle-Width="160px" HeaderText="合同名称" FooterText="合计">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
													<ItemTemplate>
												...
												<asp:TemplateColumn SortExpression="ContractId" ItemStyle-Width="150px" HeaderText="合同编号">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
													<ItemTemplate>
															<a href="##" onclick="doViewContractInfo(this.code);return false;" code='<%#  DataBinder.Eval(Container.DataItem, "ContractCode") %>'
												...
												<asp:TemplateColumn SortExpression="ChangeStatus" HeaderText="变更状态">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
													<ItemTemplate>
														<%# RmsPM.BLL.ContractRule.GetChangeStatusNameInContract(DataBinder.Eval(Container.DataItem, "ChangeStatus").ToString()) %>
													</ItemTemplate>
												</asp:TemplateColumn>												
												<asp:TemplateColumn SortExpression=""  ItemStyle-Width="300px" HeaderText="供应商">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
													<ItemTemplate>
												...
												<asp:TemplateColumn HeaderText="合同总金额（元）" SortExpression="TotalMoney">
													<HeaderStyle Wrap="False" HorizontalAlign="Right"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
													<FooterStyle HorizontalAlign="Right"></FooterStyle>
													<ItemTemplate>
														<%# DataBinder.Eval(Container, "DataItem.TotalMoney", "{0:N}") %>
													</ItemTemplate>
													<FooterTemplate>
														<asp:Label runat="server" ID="lblSumTotalMoney"></asp:Label>
													</FooterTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn HeaderText="已批（元）">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
													<ItemTemplate>
													...
													<FooterTemplate>
														<asp:Label runat="server" ID="lblSumPayment"></asp:Label>
													</FooterTemplate>													
												</asp:TemplateColumn>
												<asp:TemplateColumn HeaderText="已付（元）">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
													<ItemTemplate>
														<%# DataBinder.Eval(Container, "DataItem.APMoney", "{0:N}") %>
													</ItemTemplate>
													<FooterTemplate>
														<asp:Label runat="server" ID="lblSumAPMoney"></asp:Label>
													</FooterTemplate>													
												</asp:TemplateColumn>
												<asp:TemplateColumn HeaderText="未付（元）">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
													<ItemTemplate>
														<%# RmsPM.BLL.StringRule.BuildShowNumberString( RmsPM.BLL.ConvertRule.ToDecimal( DataBinder.Eval(Container.DataItem, "TotalMoney") ) - RmsPM.BLL.ConvertRule.ToDecimal( DataBinder.Eval(Container.DataItem, "APMoney") )  )  %>
													</ItemTemplate>
													<FooterTemplate>
														<asp:Label runat="server" ID="lblSumUPMoney"></asp:Label>
													</FooterTemplate>													
												</asp:TemplateColumn>
											</Columns>
