...
<%@ Page Language="c#" Inherits="RmsPM.Web.Contract.ContractChange" CodeFile="ContractChange.aspx.cs"
        ...
        <table id="tableMain" height="100%" cellspacing="0" cellpadding="0" width="100%"
            ...
            <tr>
                <td class="topic" align="center" background="../images/topic_bg.gif" height="25">
                    <asp:Label ID="lblTitle" runat="server" BackColor="Transparent">合同变更</asp:Label></td>
            </tr>
            <tr height="100%">
                <td valign="top">
                        ...
                        <table class="form" cellspacing="0" cellpadding="0" width="100%" border="0">
                            ...
                            <tr>
                                <td class="form-item" valign="top">
                                    变更原因及摘要：</td>
                                <td colspan="3">
                                    <textarea id="txtChangeReason" style="width: 98%" name="txtChangeReason" rows="4"
                                        runat="server"></textarea>
                                        <asp:Label runat="server" ForeColor="red" ID="lblHintChangeReason" Visible="false">*</asp:Label>
