<%@ Reference Page="~/pbs/createbuildingaction.aspx" %>
<%@ Reference Page="~/pbs/roomlist.aspx" %>
<%@ Page language="c#" Inherits="RmsPM.Web.PBS.Building_Step5" CodeFile="Building_Step5.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Building_Step5</title>
	...
	<BODY bottomMargin="0" leftMargin="0" topMargin="0" scroll="no" rightMargin="0">
				...
				<tr>
					<td class="table" align="center">
						<table border="0" cellpadding="0" cellspacing="0" class="form" width="100%">
							<tr> 
								<td height="25" valign="bottom" class="note" align="center">新建楼栋结构第五步</td>
							</tr>
							<tr>
							...
							<tr>
								<td align="center" width="70" rowSpan="2" class="list-a">
									<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr align="center">
											<td noWrap height="33%">室号</td>
										</tr>
									</table>
								</td>
								<asp:repeater id="rpDoorName" runat="server">
									<ItemTemplate>
										<td colspan='<%# DataBinder.Eval(Container.DataItem, "RoomCount") %>' align="center" class="list-c">
						...
						<table>
							<tr>
								<td><input class="submit" id="btnBack" onclick="GoBack();" type="button" value="上一步" name="btnBack" onclick="document.all.divHintLoad.style.display='';">
									<input class="submit" id="btnSubmit" type="button" value="批量生成" name="btnSubmit" runat="server" onclick="document.all.divHintSave.style.display='';" onserverclick="btnSubmit_ServerClick">
		...
		<!--
			function GoBack(){
				window.location.href = "Building_Step4.aspx?BuildingCode=" + Form1.txtBuildingCode.value + "&ProjectCode=" + Form1.txtProjectCode.value + "&DoorCount=" + Form1.txtDoorCount.value + "&action=prev";
			}
