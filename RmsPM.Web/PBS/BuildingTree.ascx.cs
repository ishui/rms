namespace RmsPM.Web.PBS
{
	...
	///		BuildingTree 的摘要说明。
	/// </summary>
	public partial class BuildingTree : System.Web.UI.UserControl
	{
		...
		public void SetParam(string ProjectCode, string BuildingCode) 
		{
			this.txtProjectCode.Value = ProjectCode;
			this.txtBuildingCode.Value = BuildingCode;
		}
	}
}
