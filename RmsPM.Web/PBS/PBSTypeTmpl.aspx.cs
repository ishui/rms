...
namespace RmsPM.Web.PBS
{
	...
	/// PBSTypeTmpl 的摘要说明。
	/// </summary>
	public partial class PBSTypeTmpl : PageBase
	{
...
//				this.txtProjectCode.Value = Request.QueryString["ProjectCode"];
				...
				((PBSTypeTreeCtrl)this.ucPBSTypeTree).SetParam(this.txtProjectCode.Value, "", "all");
			}
			catch (Exception ex)
			{
		...
		protected void btnUpdateProject_ServerClick(object sender, System.EventArgs e)
		{
			try
			{
			}
