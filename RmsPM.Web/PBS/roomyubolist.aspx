			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="tools-area" vAlign="top">
						<IMG src="../images/btn_li.gif" align="absMiddle"> <input class="button" id="btnAdd" onclick="Add()" type="button" value="新 增" name="btnAdd" runat="server"></TD>
					</TD>
				</TR>
				<tr>
								...
								<tr vAlign="top">
									<td><asp:datagrid id="dgList" runat="server" AllowPaging="True" Width="100%" CssClass="list" CellPadding="0"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="楼栋数">
													<ItemTemplate>
