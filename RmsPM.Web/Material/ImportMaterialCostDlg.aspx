	...
	<body scroll="no" onload="winload();">
		<form id="Form1" method="post" runat="server">
			<TABLE height="100%" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
				<tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">导入材料价格</td>
				</tr>
				<tr align="center">
					<td style="COLOR: blue">导入内容将新增至材料价格库</td>
				</tr>
				<tr height="100%">
									...
									<TABLE cellSpacing="0" cellPadding="0" width="90%" border="0">
										<tr>
											<td>文件格式说明：<br>
												...
												4.“类别全名”用“-&gt;”分隔，如：材料-&gt;弱电，且必须和系统类别中的材料价格类别对应
											</td>
										</tr>
									</TABLE>
								</td>
							...
							<tr>
								<td valign="bottom">
									<table cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<td class="intopic" width="200">预导入材料价格列表</td>
									...
									<div style="OVERFLOW:auto;WIDTH:100%;POSITION:absolute;HEIGHT:100%">
										<asp:datagrid id="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False" PageSize="16"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="项目" SortExpression="Project">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
													<ItemTemplate>
												...
												<asp:TemplateColumn HeaderText="定标日期" SortExpression="BiddingDate">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
													<ItemTemplate>
												...
												<asp:TemplateColumn HeaderText="描述" SortExpression="Description">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
													<ItemTemplate>
				...
				<tr>
					<td>
						<TABLE height="100%" cellSpacing="10" cellPadding="0" width="100%" border="0">
							<tr align="center">
								<td>
									<input type="button" class="submit" id="btnClear" name="btnClear" value="清空材料价格" onclick="if (!confirm('确实要删除所有材料价格吗？')) return false; document.all.divHintSave.style.display='';"
