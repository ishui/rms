<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialList.aspx.cs" Inherits="Material_MaterialList" %>
...
{   
	OpenMiddleWindow('MaterialInfo.aspx?ProjectCode=<%= Request["ProjectCode"]+"" %>&MaterialCode='+Code,'材料维护');
}
</script>
</head>
	                           ...
	                           <div style="OVERFLOW:auto;WIDTH:100%;POSITION:absolute;HEIGHT:100%">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="参考价(元)" SortExpression="StandardPrice">
                                                <ItemTemplate>
                                                        <%#RmsPM.BLL.MathRule.GetDecimalShowString( Eval("StandardPrice"))%>
                                                </ItemTemplate>
