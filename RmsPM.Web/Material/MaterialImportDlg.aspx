<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialImportDlg.aspx.cs" Inherits="Material_MaterialImportDlg" %>
    ...
    <body scroll="no">
        <form id="form1" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
			    <tr>					
			        <td class="topic" align="center" background="../images/topic_bg.gif" height="25">材料导入</td>
			    </tr>
			    <tr align="center">
				    <td style="COLOR: blue">材料将导入材料库</td>
			    </tr>
			    <tr height="100%">
			    ...
			    <tr>
			        <td>
	                    <table align="center">
                            <tr>
	                            <td>	
	                                <input class="submit" type="button" value="清 空" runat="server" id="btnDeleteAll" name="btnDeleteAll" onclick="if (!confirm('确实要删除所有材料吗？')) return false;" onserverclick="btnDeleteAll_ServerClick" />
