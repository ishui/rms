	...
	<body scroll="no">
		<form id="Form1" method="post" runat="server">
			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="#ffffff">
				<tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">材料价格</td>
				</tr>
				<tr height="100%">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form">
							<TR>
								...
								<TD><INPUT id="txtUnit" type="text" class="input" size="20" name="txtUnit"
										runat="server"></TD>
								<TD class="form-item" nowrap><asp:label runat="server" ID="lblPriceTitle">单价</asp:label>：</TD>
