<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Control_SupplierGrade.ascx.cs" Inherits="SupplierGrade_Control_SupplierGrade" %>
...
<div id="OperableDiv" runat="server">
                                    ...
                                    <tr>
                                        <td>
                                            <div id="messageMoid" runat="server">
                                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="form-item" style="height: 19px" >
                                                            &nbsp;项目名称：</td>
                                                        ...
                                                        <td class="form-item">
                                                            承包商名称：</td>
                                                        <td>
                                                            <input class="input" id="txtSupplierName" readonly type="text" name="txtSupplierName" runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#B0C5E6" style="	border-bottom: 1px solid #DCDCDC;	border-right: 1px solid #A6C6DD;	padding-left: 5px;	padding-right: 5px;	height: 23px;" >
                                    <tr>
                                        <td align="center">
                                            恶劣<br>
                                            （1~2分）</td>
                        ...
                        <tr>
                            <td  colspan="2">
                                &nbsp;
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#B0C5E6">
                                    <tr  >
                                        <td colspan="3">
                                            考虑因素</td>
                                        <td>
                                        ...
                                        <div id="GradeModify" runat="server">
                                            <asp:Repeater ID="Repeater1" runat="server">
                                                <ItemTemplate>                                                
                                                    ...
                                                    <asp:TextBox Enabled='<%# ((string)DataBinder.Eval(Container.DataItem, "issubtotal") != "1")%>'  Width="35" ID="TxtPercentage" runat="server" Text='<%# (string)DataBinder.Eval(Container.DataItem, "tempPercentage")%>'
                                                    ...
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "<td rowspan=\"2\" NOWRAP>" : ""%>
                                                    <asp:TextBox Enabled='<%# ((string)DataBinder.Eval(Container.DataItem, "issubtotal") != "1")%>' Width="35" ID="txtAgreement" runat="server" Text='<%# (string)DataBinder.Eval(Container.DataItem, "AgreementPoint")%>'
                                                    ...
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "&nbsp;</td>" : ""%>
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "<td rowspan=\"2\" NOWRAP>" : ""%>
                                                    <asp:TextBox Enabled='<%# ((string)DataBinder.Eval(Container.DataItem, "issubtotal") != "1")%>' Width="35" ID="txtTechnic" runat="server" Text='<%# (string)DataBinder.Eval(Container.DataItem, "TechnicPoint")%>'
                                                    ...
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "&nbsp;</td>" : ""%>
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "<td rowspan=\"2\" NOWRAP>" : ""%>
                                                    <asp:TextBox Enabled='<%# ((string)DataBinder.Eval(Container.DataItem, "issubtotal") != "1")%>' Width="35" ID="txtItemMajordomo" runat="server" Text='<%#(string)DataBinder.Eval(Container.DataItem, "ItemMajordomoPoint")%>'
                                                    ...
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "&nbsp;</td>" : ""%>
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "<td rowspan=\"2\" NOWRAP>" : ""%>
                                                    <asp:TextBox Enabled='<%# ((string)DataBinder.Eval(Container.DataItem, "issubtotal") != "1")%>' Width="35" ID="txtItemAgreement" runat="server" Text='<%# (string)DataBinder.Eval(Container.DataItem, "ItemAgreementPoint")%>'
                                                   ...
                                                   <asp:Label ID="lblItemAgreement" runat="server" Visible="False" Text='<%# (string)DataBinder.Eval(Container.DataItem, "ItemAgreementCode")%>'></asp:Label>
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "&nbsp;</td>" : ""%>
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "<td rowspan=\"2\" NOWRAP>" : ""%>
                                                    <asp:TextBox Enabled='<%# ((string)DataBinder.Eval(Container.DataItem, "issubtotal") != "1")%>' Width="35" ID="txtItemEngineering" runat="server" Text='<%#(string)DataBinder.Eval(Container.DataItem, "ItemEngineeringPoint")%>'
                                                    ...
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "&nbsp;</td>" : ""%>
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "<td rowspan=\"2\" NOWRAP>" : ""%>
                                                    <asp:TextBox Enabled='<%# ((string)DataBinder.Eval(Container.DataItem, "issubtotal") != "1")%>' Width="35" ID="txtItemDesign" runat="server" Text='<%# (string)DataBinder.Eval(Container.DataItem, "ItemDesignPoint")%>'
                                                    ...
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "&nbsp;</td>" : ""%>
                                                    <%# ((string)DataBinder.Eval(Container.DataItem, "ChildCount") == "0" && (string)DataBinder.Eval(Container.DataItem, "freeflag") == "1") ? "<td rowspan=\"2\" NOWRAP>" : ""%>
                                                    <asp:TextBox Enabled='<%# ((string)DataBinder.Eval(Container.DataItem, "issubtotal") != "1")%>' Width="35" ID="txtClientService" runat="server" Text='<%#(string)DataBinder.Eval(Container.DataItem, "ClientServicePoint")%>'
