<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Control_SupplierGradeOpinion.ascx.cs" Inherits="SupplierGrade_Control_SupplierGradeOpinion" %>
...
<tr>
                            ...
                            <div id="messageMoid" runat="server">
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#B0C5E6">
                                    <tr>
                                        <td class="form-item"  class="blackbordertdcontent">
                                            项目名称</td>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td>
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#B0C5E6">
                                    <tr>
                                        <td>
                                            评定结果:</td>
                                    </tr>
