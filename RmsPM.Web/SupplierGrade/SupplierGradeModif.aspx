<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierGradeModif.aspx.cs" Inherits="SupplierGrade_SupplierGradeModif" %>
...
<%@ Register Src="Control_SupplierGradeOpinion.ascx" TagName="Control_SupplierGradeOpinion"
    TagPrefix="uc2" %>
...
<%@ Register TagPrefix="uc1" TagName="OperationControl" Src="Control_SupplierGrade.ascx" %>
...
<body>
    <form id="Form1" runat="server">
        <table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
                <tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">供应商评分</td>
				</tr>
				<tr>
					<td style="height: 25px">
						<table class="table" id="tableToolBar" width="100%">
							...
							value="修  改" name="btnModify" runat="server" visible=false onserverclick="btnModify_ServerClick"> <input class="button" id="btnSave" type="button"
							value="保  存" onserverclick="btnSave_ServerClick" name="btnSave" runat="server" visible=false >
							<input  class="button" id="btnOldCheck" type="button"	value="审  核" name="btnOldCheck" visible="false" runat="server">
							 <input  class="button" id="btnCheck" type="button"	value="提交审核" name="btnCheck" visible=false runat="server" onclick="doGrade();return false;"> 
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td valign="top" colspan=10>
                                    <uc2:Control_SupplierGradeOpinion ID="ucGradeOpinionControl" runat="server" />
    ...
    function doGrade()
		{
			OpenFullWindow('<%= SupplierGradePage%>?ProjectCode=<%=ProjectCode%>&gradeMessageCode=<%=GradeMessageCode%>&SupplierCode=<%=SupplierCode%>','评分');
		}
