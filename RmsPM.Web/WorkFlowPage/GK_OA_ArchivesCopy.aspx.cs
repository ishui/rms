...
public partial class WorkFlowPage_GK_OA_ArchivesCopy : WorkFlowPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            this.WorkFlowName = "档案复印/借用审批";
    ...
    override protected void OperationControlInit()
    {
        ...
        this.up_ucOperationControl.OperationCode = Request.QueryString["ArchivesCopyCode"];
