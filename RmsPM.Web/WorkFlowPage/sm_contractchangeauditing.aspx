...
<%@ Reference Control="~/workflowoperation/sm_contractchangeauditing.ascx" %>
<%@ Page language="c#" Inherits="WorkFlowPage_SM_ContractChangeAuditing" CodeFile="SM_ContractChangeAuditing.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="OperationControl" Src="../WorkFlowOperation/SM_ContractChangeAuditing.ascx" %>
