...
public partial class WorkFlowPage_GK_OA_OfficialSealRegiester : WorkFlowPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            this.WorkFlowName = "公章使用登记表";
    ...
    override protected void OperationControlInit()
    {
        ...
        this.up_ucOperationControl.OperationCode = Request.QueryString["OfficialSealRegiesterCode"];
