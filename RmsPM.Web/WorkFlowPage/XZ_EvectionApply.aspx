<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XZ_EvectionApply.aspx.cs" Inherits="WorkFlowPage_XZ_EvectionApply" %>

<%@ Register Src="../WorkFlowOperation/XZ_EvectionApply.ascx" TagName="OperationControl"
    TagPrefix="uc1" %>
            ...
            <tr>
                <td id="td_Print" runat="server" class="table" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" class="blackbordertable" width="100%">
                        ...
                        <tr>
                            <td class="blackbordertd" colspan="2" style="width:100%">
                                <uc1:OperationControl id="ucOperationControl" runat="server">
                                </uc1:OperationControl></td>
                        </tr>
                        <tr>
                            <td colspan="2">
