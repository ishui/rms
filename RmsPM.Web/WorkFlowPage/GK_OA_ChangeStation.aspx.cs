...
public partial class WorkFlowPage_GK_OA_ChangeStation : WorkFlowPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            this.WorkFlowName = "员工转岗申请审批";
    ...
    override protected void OperationControlInit()
    {
        ...
        this.up_ucOperationControl.OperationCode = Request.QueryString["ChangeStationCode"];
    ...
    override protected void PageControlInit()
    {
        ...
        /**************************************************************************************/
        OpinionControlInit("意见", "GK_OA_ChangeStation_申请人意见", "申请表", this.wfoOpinion1);
    ...
    private void dgSignSheet_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        ...
        switch (e.Item.ItemType)
        {
            ...
            case ListItemType.Item:
                ...
                OpinionControlInit(ud_sRoleName + "意见", "GK_OA_ChangeStation_" + ud_sRoleName, ud_sRoleName, (WorkFlowFormOpinion)e.Item.FindControl("wfoSignSheet"));
                break;
            default:
                break;
        }
