...
public partial class WorkFlowPage_ZC_EquimentMaintain : WorkFlowPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            this.WorkFlowName = "设备维护申请";
    ...
    override protected void OperationControlInit()
    {
        ...
        this.up_ucOperationControl.OperationCode = Request.QueryString["Code"];
