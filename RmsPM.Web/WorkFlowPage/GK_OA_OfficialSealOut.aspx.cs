...
public partial class WorkFlowPage_GK_OA_OfficialSealOut : WorkFlowPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            this.WorkFlowName = "公章外出登记审批";
    ...
    override protected void OperationControlInit()
    {
        ...
        this.up_ucOperationControl.OperationCode = Request.QueryString["OfficialSealOutCode"];
