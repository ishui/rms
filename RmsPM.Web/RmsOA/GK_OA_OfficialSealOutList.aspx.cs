...
public partial class RmsOA_GK_OA_OfficialSealOutList : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (user.HasRight("300201"))
            {
                ...
                this.NewButton.Attributes["OnClick"] = "javascript:OpenMiddleWindow('GK_OA_OfficialSealOutEdit.aspx?ActType=add','OfficialSealOutEdit');";
            }
            else
            {
