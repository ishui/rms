<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GK_OA_OfficialSealOutEdit.aspx.cs"
    Inherits="RmsOA_GK_OA_OfficialSealOutEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        {
		    OpenFullWindow('<%= RmsPM.BLL.WorkFlowRule.GetProcedureURLByName("公章外出登记审批")%>?OfficialSealOutCode=<%= FormView1.DataKey.Value %>&ProjectCode=<%= Request["ProjectCode"] + ""%>','公章外出登记审批');
        }
    </script>
            ...
            <tr>
                <td valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="form" width="100%">
                                ...
                                <tr>
                                    <td class="form-item" style="width: 20%">
                                        公章/证照名：</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="OfficialSealNameTextBox" runat="server" Text='<%# Bind("OfficialSealName") %>'
                                            CssClass="input" Width="100%"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="form-item" style="width: 20%">
                                        外出时间：</td>
                                    <td>
                                        <cc3:Calendar ID="OutDateCalendar" runat="server" CalendarMode="Date" CalendarResource="../Images/CalendarResource/"
                                            Display="True" ReadOnly="False" Value='<%# Bind("OutDate") %>'>
                                        </cc3:Calendar>
                                    </td>
                                    <td class="form-item" style="width: 20%">
                                        归还时间：</td>
                                    <td>
                                        <cc3:Calendar ID="Calendar" runat="server" CalendarMode="Date" CalendarResource="../Images/CalendarResource/"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="form" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        &nbsp;
                                        <asp:TextBox ID="OfficialSealNameTextBox" runat="server" Text='<%# Bind("OfficialSealName") %>'
                                             Width="90%" CssClass="input"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="OfficialSealNameTextBox"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="OfficialSealNameTextBox"
                                            ErrorMessage="*"></asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                    <td class="form-item" style="width: 20%">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="RmsOA.MODEL.GK_OA_OfficialSealOutModel"
                        DeleteMethod="Delete" InsertMethod="Insert" SelectMethod="GetGK_OA_OfficialSealOutListOne"
                        TypeName="RmsOA.BFL.GK_OA_OfficialSealOutBFL" UpdateMethod="Update"
