<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RS_ManpowerNeedList.aspx.cs"
    Inherits="RmsOA_RS_ManpowerNeedList" %>

<%@ Register TagPrefix="cc3" Namespace="AspWebControl" Assembly="AspWebControl" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>人力资源需求列表</title>
            ...
            <tr height="100%">
                <td class="table" valign="top">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="文件编号">
                                <ItemTemplate>
                                    <a href="#" onClick="javascript:OpenMiddleWindow('RS_ManPowerNeedEdit.aspx?Code=<%# Eval("Code")%>','ManPowerDetail');return false;">
                                        <%# Eval("SystemCode")%>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="PersonNumber" HeaderText="人数" SortExpression="PersonNumber" />
                            <asp:BoundField DataField="RegistDate" HeaderText="登记时间" SortExpression="RegistDate" />
                            <asp:TemplateField HeaderText="状态" SortExpression="Status">
                                <ItemTemplate>
                                    <%# RmsOA.BFL.GK_OA_ManpowerNeedBFL.GetManpowerNeedStatusName((string)Eval("Status")) %>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="MaxRecords"
                        SelectMethod="GetGK_OA_ManpowerNeedList" SortParameterName="SortColumns" StartRowIndexParameterName="StartRecord"
                        TypeName="RmsOA.BFL.GK_OA_ManpowerNeedBFL">
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="txtUnit" Name="UnitCodeEqual" PropertyName="Value"
                                Type="String" />
                            <asp:ControlParameter ControlID="RegisterDateEnd" Name="RegistDateEndEqual" PropertyName="Value"
                                Type="DateTime" />
                            <asp:ControlParameter ControlID="RegisterDateStart" Name="RegistDateStartEqual" PropertyName="Value"
                                Type="DateTime" />
