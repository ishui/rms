...
public partial class RmsOA_GK_OA_WorkEvaluationList : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (user.HasRight("050102"))
            {
                ...
                this.NewButton.Attributes["OnClick"] = "javascript:OpenMiddleWindow('GK_OA_WorkEvaluationEdit.aspx?ActType=add','ChangeStationEdit');";
            }
            else
            {
