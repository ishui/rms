...
public partial class RmsOA_RS_ChangeStationEdit : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (FormView1.CurrentMode == FormViewMode.ReadOnly)
            {
                ...
                work.ProcedureNameAndApplicationCodeList = "'员工转岗申请审批" + this.FormView1.DataKey.Value.ToString() + "'";
                work.DataBound();
            }
    ...
    protected void btnBankOut_Click(object sender, EventArgs e)
    {
        try
        {
            RmsOA.BFL.GK_OA_ChangeStationBFL bfl = new RmsOA.BFL.GK_OA_ChangeStationBFL();
