<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GK_OA_OutFileRegisterList.aspx.cs"
    Inherits="RmsOA_GK_OA_OutFileRegisterList" %>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            收文人</td>
                                        <td>
                                            <asp:TextBox ID="UserCodeTextBox" runat="server" CssClass="input"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            部门</td>
            ...
            <tr height="100%">
                <td class="table" valign="top">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="文件编号">
                                <ItemTemplate>
                                    <a href="#" onClick="javascript:OpenMiddleWindow('GK_OA_OutFileRegisterEdit.aspx?Code=<%# Eval("Code")%>','OutFileRegisterDetail');return false;">
                                        <%# Eval("FileCode")%>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="RegiesterDate" HeaderText="日期" SortExpression="RegiesterDate" />
                            <asp:BoundField DataField="FileNumeber" HeaderText="文件编号" SortExpression="FileNumeber" />
                            <asp:BoundField DataField="Detail" HeaderText="摘要" SortExpression="Detail" />
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="MaxRecords"
                        SelectMethod="GetGK_OA_OutFileRegiesterList" SortParameterName="SortColumns"
                        StartRowIndexParameterName="StartRecord" TypeName="RmsOA.BFL.GK_OA_OutFileRegiesterBFL">
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="UserCodeTextBox" Name="UserCodeEqual" PropertyName="Text"
                                Type="String" />
                            ...
                            <asp:ControlParameter ControlID="txtUnit" Name="UnitCodeEqual" PropertyName="Value"
                                Type="String" />
                            <asp:ControlParameter ControlID="RegisterDateStart" Name="RegiesterDateEqualStart"
                                PropertyName="Value" Type="DateTime" />
                            <asp:ControlParameter ControlID="RegisterDateEnd" Name="RegiesterDateEqualEnd" PropertyName="Value"
                                Type="DateTime" />
                        </SelectParameters>
