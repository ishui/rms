<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GK_OA_FileChangeList.aspx.cs"
    Inherits="RmsOA_GK_OA_FileChangeList" %>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td>
                                            标识序号</td>
                                        <td>
                                            <asp:TextBox ID="FileSystemCodeTextBox" runat="server" CssClass="input"></asp:TextBox></td>
                                        <td>
                                            文件名称</td>
                                        <td>
            ...
            <tr height="100%">
                <td class="table" valign="top">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="文件名称">
                                <ItemTemplate>
                                    <a href="#" onClick="javascript:OpenMiddleWindow('GK_OA_FileChangeEdit.aspx?Code=<%# Eval("Code")%>','FileChangeDetail');return false;">
                                        <%# Eval("FileName")%>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="OldVersionNumber" HeaderText="原版本号" SortExpression="OldVersionNumber" />
                            <asp:BoundField DataField="NewVersionNumber" HeaderText="现版本号" SortExpression="NewVersionNumber" />
                            <asp:TemplateField HeaderText="提交时间">
                                <ItemTemplate>
                                    <%# Eval("SubmitDate").ToString().Substring(0,10)%>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="MaxRecords"
                        SelectMethod="GetGK_OA_FileChangeList" SortParameterName="SortColumns" StartRowIndexParameterName="StartRecord"
                        TypeName="RmsOA.BFL.GK_OA_FileChangeBFL">
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="FileCodeTextBox" Name="FileCodeEqual" PropertyName="Text"
                                Type="String" />
                            <asp:ControlParameter ControlID="FileSystemCodeTextBox" Name="FileSystemCodeEqual" PropertyName="Text"
                                Type="String" />
                                 
                            <asp:ControlParameter ControlID="txtUnit" Name="UnitCodeEqual" PropertyName="Value"
                                Type="String" />
                            <asp:ControlParameter ControlID="RegisterDateStart" Name="SubmitDateEqualStart" PropertyName="Value"
                                Type="DateTime" />
                            <asp:ControlParameter ControlID="RegisterDateEnd" Name="SubmitDateEqualEnd" PropertyName="Value"
                                Type="DateTime" />
