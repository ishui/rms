...
public partial class RmsOA_GK_OA_InFileRegisterMainEdit : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (FormView1.CurrentMode == FormViewMode.ReadOnly)
            {
                ...
                this.ObjectDataSource2.SelectParameters["RegisterMainCodeEqual"].DefaultValue = this.FormView1.DataKey.Value.ToString();
            }
        }
    }
