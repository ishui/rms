<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GK_OA_WorkEvaluationList.aspx.cs" Inherits="RmsOA_GK_OA_WorkEvaluationList" %>
            ...
            <tr height="100%">
                <td class="table" valign="top">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="文件编号">
                                <ItemTemplate>
                                    <a href="#" onClick="javascript:OpenMiddleWindow('GK_OA_WorkEvaluationEdit.aspx?Code=<%# Eval("Code")%>','ManPowerDetail');return false;">
                                        <%# Eval("SystemCode")%>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="FileCode" HeaderText="标识序号" SortExpression="FileCode" />
                            <asp:BoundField DataField="PersonName" HeaderText="岗位" SortExpression="PersonName" />
                            <asp:BoundField DataField="InComDate" HeaderText="登记时间" SortExpression="InComDate" />
                            <asp:TemplateField HeaderText="状态" SortExpression="Status">
                                <ItemTemplate>
                                    <%# RmsOA.BFL.GK_OA_WorkEvaluationBFL.GetManpowerNeedStatusName((string)Eval("Status")) %>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="MaxRecords"
                        SelectMethod="GetGK_OA_WorkEvaluationList" SortParameterName="SortColumns" StartRowIndexParameterName="StartRecord"
                        TypeName="RmsOA.BFL.GK_OA_WorkEvaluationBFL">
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="PersonNameTextBox" Name="PersonNameEqual" PropertyName="Text"
                                Type="String" />
                            <asp:ControlParameter ControlID="RegisterDateEnd" Name="InComDateEnd" PropertyName="Value"
                                Type="DateTime" />
                            <asp:ControlParameter ControlID="RegisterDateStart" Name="InComDateStart" PropertyName="Value"
                                Type="DateTime" />
