<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GK_OA_OfficialSealRegisterList.aspx.cs"
    Inherits="RmsOA_GK_OA_OfficialSealRegisterList" %>

<%@ Register TagPrefix="cc3" Namespace="AspWebControl" Assembly="AspWebControl" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>公章使用登记列表</title>
            ...
            <tr height="100%">
                <td class="table" valign="top">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="摘要">
                                <ItemTemplate>
                                    <a href="#" onClick="javascript:OpenMiddleWindow('GK_OA_OfficialSealRegisterEdit.aspx?Code=<%# Eval("Code")%>','OfficialSealRegiesterDetail');return false;">
                                        <%# Eval("Remark")%>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="状态" SortExpression="Status">
                                <ItemTemplate>
                                    <%# RmsOA.BFL.GK_OA_OfficialSealRegiesterBFL.GetManpowerNeedStatusName((string)Eval("Status")) %>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="MaxRecords"
                        SelectMethod="GetGK_OA_OfficialSealRegiesterList" SortParameterName="SortColumns"
                        StartRowIndexParameterName="StartRecord" TypeName="RmsOA.BFL.GK_OA_OfficialSealRegiesterBFL">
                        <SelectParameters>
