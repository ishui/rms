<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RS_ChangeStationList.aspx.cs" Inherits="RmsOA_RS_ChangeStationList" %>
            ...
            <tr height="100%">
                <td class="table" valign="top">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="文件编号">
                                <ItemTemplate>
                                    <a href="#" onClick="javascript:OpenMiddleWindow('RS_ChangeStationEdit.aspx?Code=<%# Eval("Code")%>','ChangeStationDetail');return false;">
                                        <%# Eval("SystemCode")%>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="MaxRecords"
                        SelectMethod="GetGK_OA_ChangeStationList" SortParameterName="SortColumns" StartRowIndexParameterName="StartRecord"
                        TypeName="RmsOA.BFL.GK_OA_ChangeStationBFL">
                        <SelectParameters>
