<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GK_OA_WorkEvaluationEdit.aspx.cs" Inherits="RmsOA_GK_OA_WorkEvaluationEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        {
		    OpenFullWindow('<%= RmsPM.BLL.WorkFlowRule.GetProcedureURLByName("工作鉴定审批")%>?WorkEvaluationCode=<%= FormView1.DataKey.Value %>&ProjectCode=<%= Request["ProjectCode"] + ""%>','工作鉴定审批');
        }
    </script>
            ...
            <tr>
                <td valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="form" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="form-item" style="width: 20%">
                                        岗位：</td>
                                    <td>
                                        <asp:TextBox ID="StationTextBox" runat="server" CssClass="input" Text='<%# Bind("StationCode") %>'></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="form-item" style="width: 20%">
                                        工作表现：</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="WorkPperationTextBox" runat="server" Text='<%# Bind("WorkPperation") %>'
                                ...
                                <tr>
                                    <td class="form-item" style="width: 20%">
                                        优缺点：</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="MeritsAndDemeritsTextBox" runat="server" Text='<%# Bind("MeritsAndDemerits") %>' TextMode="MultiLine"
                                ...
                                <tr>
                                    <td class="form-item" style="width: 20%">
                                        决定批示：</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="RemarkTextBox" runat="server" Text='<%# Bind("Decide") %>' TextMode="MultiLine"
                                            Width="100%"></asp:TextBox></td>
                                </tr>
                            </table>
                        </EditItemTemplate>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="RmsOA.MODEL.GK_OA_WorkEvaluationModel"
                        DeleteMethod="Delete" InsertMethod="Insert" SelectMethod="GetGK_OA_WorkEvaluationListOne"
                        TypeName="RmsOA.BFL.GK_OA_WorkEvaluationBFL" UpdateMethod="Update" OnInserted="ObjectDataSource1_Inserted">
                        <SelectParameters>
