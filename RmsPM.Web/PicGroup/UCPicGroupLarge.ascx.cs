namespace RmsPM.Web.PicGroup
{
	...
	///	<version></version>
	///	
	public partial class UCPicGroupLarge : System.Web.UI.UserControl
	{
        ...
        public void SetReadonly(bool value)
        {
            if (value)
            {
                this.btnCreatePicGroup.Visible = false;
                this.btnModifyPicGroup.Visible = false;
            }
            else
            {
                this.btnCreatePicGroup.Visible = true;
                this.btnModifyPicGroup.Visible = true;
            }
        }
