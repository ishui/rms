<%@ Control Language="c#" Inherits="RmsPM.Web.PicGroup.UCPicGroupLarge" CodeFile="UCPicGroupLarge.ascx.cs" %>
<TABLE id="Table1" cellSpacing="0" cellPadding="4" width="100%" height="100%" border="0" style="background-color:#ffffff">
...
<!--
	...
	var thePrivateMaxWidth = 480;
	var thePrivateMaxHeight = 480;
...
//-->
	...
	<TR>
		<TD class="tools-area" vAlign="top" noWrap><IMG src="../images/btn_li.gif" align="absMiddle">
		        <input class="button" id="btnCreatePicGroup" onclick="doThePGWork('btnCreatePicGroup');return false;" type="button"
							value="新增相册" name="btnCreatePicGroup" runat="server">
		        <input class="button" id="btnModifyPicGroup" onclick="doThePGWork('btnModifyPicGroup');return false;" type="button"
							value="修改相册" name="btnModifyPicGroup" runat="server">
		</TD>
	</TR>
	<TR>
		<TD style="height:100%" class="table" valign="top">
		    <table border="0" cellpadding="0" cellspacing="0" height="100%">
		        <tr>
		            <td style="height:100%;width:100%;BORDER-RIGHT: #ededed 2px dotted; PADDING-RIGHT: 7px">
		            ...
		            <td valign="top" style="PADDING-LEFT: 7px;">
		                <table width="480px" height="100%" border="0" cellSpacing="0" cellPadding="4">
				            <TR style="height:100%">
					            <TD vAlign="middle" noWrap align="center" colSpan="2"><IMG id="PicPrivate" alt="" src="<%=strRootPath%>Images/PicGroup/splash.gif" border="0" onload="thePicPrivateOnLoad(this);"></TD>
				            </TR>
				            <TR>
					            <TD noWrap align="left"><a id="btnPlay" href="#" onclick="doThePGWork(this.id);return false;"><IMG alt="播放" src="<%=strRootPath%>Images/PicGroup/button_play.gif" border="0"></a>&nbsp;<a id="btnStop" href="#" onclick="doThePGWork(this.id);return false;"><IMG alt="停止" src="<%=strRootPath%>Images/PicGroup/button_stop.gif" border="0"></a>&nbsp;<a id="btnBack" href="#" onclick="doThePGWork(this.id);return false;"><IMG alt="上一张" src="<%=strRootPath%>Images/PicGroup/button_back.gif" border="0"></a>&nbsp;<a id="btnFw" href="#" onclick="doThePGWork(this.id);return false;"><IMG alt="下一张" src="<%=strRootPath%>Images/PicGroup/button_fw.gif" border="0"></a></TD>
					            <TD noWrap align="right"><a id="btnFull" href="#" onclick="doThePGWork(this.id);return false;"><IMG alt="查看完全尺寸图片。" src="<%=strRootPath%>Images/PicGroup/button_full.gif" border="0"></a></TD>
				            </TR>
		                </table>
		            </td>
		        </tr>
