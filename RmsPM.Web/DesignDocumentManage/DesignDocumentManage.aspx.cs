...
{
    public partial class DesignDocumentManage_DesignDocumentManage : PageBase
    {
        ...
        private void DataSubmit(StandardEntityDAO dao)
        {
            ...
            if (this.DesignDocument1.State == ModuleState.Operable)
            {
                ...
                this.DesignDocument1.DocumentState = "s1";
            ...
            if (this.ViewState["ConfirmControl"] != null)
            {
                ...
                {
                    this.DesignDocument1.dao = dao;
                    this.DesignDocument1.ConfirmData(true,"s");
                 }
                else if (OpinionConfirm == "Reject")
                {
                    this.DesignDocument1.dao = dao;
                    this.DesignDocument1.ConfirmData(false, "s");
                 }
            }
            ...
            if (this.Workflowformopinion1.State == ModuleState.Operable)
            {
                ...
                this.Workflowformopinion1.CaseCode = this.WorkFlowToolbar1.CaseCode;
            ...
            if (this.Workflowformopinion2.State == ModuleState.Operable)
            {
                ...
                this.Workflowformopinion2.CaseCode = this.WorkFlowToolbar1.CaseCode;
            ...
            if (this.Workflowformopinion3.State == ModuleState.Operable)
            {
                ...
                this.Workflowformopinion3.CaseCode = this.WorkFlowToolbar1.CaseCode;
            ...
            if (this.Workflowformopinion4.State == ModuleState.Operable)
            {
                ...
                this.Workflowformopinion4.CaseCode = this.WorkFlowToolbar1.CaseCode;
            ...
            if (this.Workflowformopinion5.State == ModuleState.Operable)
            {
                ...
                this.Workflowformopinion5.CaseCode = this.WorkFlowToolbar1.CaseCode;
            ...
            if (this.Workflowformopinion6.State == ModuleState.Operable)
            {
                ...
                this.Workflowformopinion6.CaseCode = this.WorkFlowToolbar1.CaseCode;
            ...
            if (this.Workflowformopinion7.State == ModuleState.Operable)
            {
                ...
                this.Workflowformopinion7.CaseCode = this.WorkFlowToolbar1.CaseCode;
            ...
            if (this.Workflowformopinion8.State == ModuleState.Operable)
            {
                ...
                this.Workflowformopinion8.CaseCode = this.WorkFlowToolbar1.CaseCode;
