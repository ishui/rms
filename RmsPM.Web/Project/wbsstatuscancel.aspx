...
<%@ Page language="c#" Inherits="RmsPM.Web.Project.WBSStatusCancel" CodeFile="WBSStatusCancel.aspx.cs" %>
	...
	<HEAD>
		...
		<script>
				<!--
					...
					{
						window.location.href = "WBSStatusCancel.aspx?" + Condition +"&TaskStatus=<%=Request["TaskStatus"]%>&ProjectCode=<%=Request["ProjectCode"]%>&TaskExceed=" + document.all.TaskExceed.value;
					}
							...
							<tr>
								<TD>开始时间从
									...
									&nbsp;&nbsp;工作名称/编码：<input class="input" id="txtTaskName" style="WIDTH: 120px" type="text" name="txtTaskName"
										runat="server"> &nbsp;&nbsp;负责人：<input class="input" id="txtMaster" style="WIDTH: 120px" type="text" name="txtMaster" runat="server">
								</TD>
							</tr>
							<tr>
								<td>结束时间从
				...
				<tr height="100%">
					<TD vAlign="top" class="table">
						<div style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 100%">
							<asp:datagrid id="dgTaskList" runat="server" AllowSorting="True" Width="100%" AutoGenerateColumns="False"
								DataKeyField="WBSCode" CssClass="list">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="PlannedFinishDate" SortExpression="PlannedFinishDate" HeaderText="计划结束时间"
										DataFormatString="{0:yyyy-MM-dd}"></asp:BoundColumn>
									<asp:BoundColumn DataField="CancelReason" HeaderText="取消原因" DataFormatString="{0:10}"></asp:BoundColumn>
									<asp:BoundColumn DataField="CancelDate" HeaderText="取消时间" DataFormatString="{0:yyyy-MM-dd}"></asp:BoundColumn>
								</Columns>
							...
							<table width="100%">
								<tr id="trNoTask" runat="server">
									<td align="center" width="100%">没有符合条件的工作信息</td>
								</tr>
							</table>
						</div>
					</TD>
