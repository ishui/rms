...
<%@ Page language="c#" Inherits="RmsPM.Web.Project.WBSStatusFinish" CodeFile="WBSStatusFinish.aspx.cs" %>
	...
	<HEAD>
		...
		<script>
				<!--
					...
					{
						window.location.href = "WBSStatusFinish.aspx?" + Condition +"&TaskStatus=<%=Request["TaskStatus"]%>&ProjectCode=<%=Request["ProjectCode"]%>&TaskExceed=" + document.all.TaskExceed.value;
					}
