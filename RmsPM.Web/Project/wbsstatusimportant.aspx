<%@ Page language="c#" Inherits="RmsPM.Web.Project.WBSStatusImportant" CodeFile="WBSStatusImportant.aspx.cs" %>
	...
	<HEAD>
		...
		<script>
				<!--
					...
					{
						window.location.href = "WBSStatusImportant.aspx?" + Condition +"&TaskStatus=<%=Request["TaskStatus"]%>&ProjectCode=<%=Request["ProjectCode"]%>&TaskExceed=" + document.all.TaskExceed.value;
					}
							...
							<tr>
								<TD>开始时间从
									...
									<cc3:calendar id="dtbStartToDate" runat="server" Display="True" ReadOnly="False" CalendarResource="../Images/CalendarResource/"
										Value=""></cc3:calendar>
									&nbsp;&nbsp;工作名称/编码：<input class="input" id="txtTaskName" size="18" type="text" name="txtTaskName"
										runat="server">
									&nbsp;&nbsp;负责人：<input class="input" id="txtMaster" size="10" type="text" name="txtMaster" runat="server">
								</td>
							</tr>
							<tr>
								<td>结束时间从
									...
									<cc3:calendar id="dtbEndToDate" runat="server" Display="True" ReadOnly="False" CalendarResource="../Images/CalendarResource/"
										Value=""></cc3:calendar>
									&nbsp;&nbsp;是否超期：<select id="lstExceed" style="WIDTH: 120px" name="lstImportantLevel" runat="server">
										<OPTION value="" selected>－－请选择－－</OPTION>
										<OPTION value="0">没有超期</OPTION>
