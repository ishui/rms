...
namespace RmsPM.Web.Project
{
	...
	/// <version>1.5</version>
	public partial class WBSStatusCancel : PageBase
	{
		protected System.Web.UI.HtmlControls.HtmlSelect lstStatus;
		protected System.Web.UI.HtmlControls.HtmlSelect lstExceed;
		...
		private void LoadData()
		{
			try
			{
				...
				WSB.AddStrategy( new Strategy( DAL.QueryStrategy.WBSStrategyName.Status,"3"));
