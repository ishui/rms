...
namespace RmsPM.Web.Cost
{
	...
	/// CBSData 的摘要说明。
	/// </summary>
	public partial class CostEstimateData : PageBase
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				m_Table.Columns.Add("EstimateMark");				// 估算标准
				m_Table.Columns.Add("MeasurementUnit");				// 计量单位
				m_Table.Columns.Add("UnitPrice");					// 单价
				m_Table.Columns.Add("ProjectQuantity");				// 数量
				m_Table.Columns.Add("TotalMoney");					// 估算费用
				m_Table.Columns.Add("ProjectQuantityDescription");	// 数量描述
				...
				EntityData m_Cost = BLL.CBSRule.GetAccessV_CBSCost(projectCode,user.UserCode,user.BuildStationCodes(),true,fromNodeCode);
