<%@ Page Language="c#" Inherits="RmsPM.Web.WorkFlowControl.WorkFlowBackEx" CodeFile="WorkFlowBackEx.aspx.cs" %>
...
<body>
	...
	function getSelectTaskActor()
	{
		...
		var taskActorIDs = Form1.txtTaskActorIDs.value.substr(0,Form1.txtTaskActorIDs.value.length-1).split(',');
