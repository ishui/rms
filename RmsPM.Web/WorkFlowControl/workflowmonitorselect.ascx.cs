namespace RmsPM.Web.WorkFlowControl
{
    ...
    public partial class workflowselect : System.Web.UI.UserControl
    {
        ...
        protected string _ReturnFunc = "";
        public string _ReturnFuncJs = "";
        /// <summary>
        /// 返回函数
        /// </summary>
        public string ReturnFunc
        {
            ...
            set
            {
                ...
                if (_ReturnFunc.Trim() != "")
                {
                   // _ReturnFuncJs = _ReturnFunc.Trim() + "(CaseCode,Name,flag);";
                    _ReturnFuncJs = _ReturnFunc.Trim() + "(CaseCode,ActCode,ApplicationPath,ApplicationCode,Status,Name,flag);";
                }
                else
                {
                    _ReturnFuncJs = "";
