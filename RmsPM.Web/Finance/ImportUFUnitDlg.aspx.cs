...
{
	/// <summary>
	/// ImportUFUnitDlg 的摘要说明。
	/// </summary>
	public partial class ImportUFUnitDlg : PageBase
	{
		...
		private void ImportUFUnitSingle(string s, SingleEntityDAO dao, EntityData entity) 
		{
