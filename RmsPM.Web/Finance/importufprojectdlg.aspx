		...
		<form id="Form1" method="post" runat="server">
			<TABLE height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="#ffffff">
				<tr align="center" height="50">
					<td><asp:label Runat="server" id="Label1" Font-Bold="True">导入核算项目</asp:label></td>
				</tr>
				<tr align="center">
					<td style="color:blue">导入内容将覆盖所有核算项目</td>
				</tr>
				...
				<tr>
					<td>
						<TABLE height="100%" cellSpacing="0" cellPadding="10" width="100%" border="0">
							<tr align="center">
								<td><input type="button" class="submit" id="btnOK" name="btnOK" value="导入" onclick="document.all.hint.style.display='block';"
