<%@ Page language="c#" Inherits="RmsPM.Web.Finance.FinanceInterfaceAnalysisUnitModify" CodeFile="FinanceInterfaceAnalysisUnitModify.aspx.cs" %>
	...
	<body scroll="no">
		<form id="Form1" method="post" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="#ffffff">
				<tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">部门财务编码</td>
				</tr>
				<tr height="100%">
					<td class="topic" vAlign="top" align="center">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form">
							<TR>
								<TD width="80" class="form-item">部门：</TD>
								<TD><asp:Label Runat="server" ID="lblUnitName"></asp:Label></TD>
							</TR>
							<tr>
			...
			<input id="txtAct" type="hidden" name="txtAct" runat="server"> <input id="txtUnitCode" type="hidden" name="txtUnitCode" runat="server">
