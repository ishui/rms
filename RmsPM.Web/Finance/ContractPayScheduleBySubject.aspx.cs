...
{
	/// <summary>
	/// ContractPayScheduleBySubject 的摘要说明。
	/// </summary>
	public partial class ContractPayScheduleBySubject : PageBase
	{
        ...
        */
		...
		private void IniPage()
		{
			try
			{
                ...
                this.sltGroupBy.Value = Request.QueryString["GroupBy"] + "";
		...
		private void LoadDataGrid(bool IsScreenToTable)
		{
			try 
			{
                ...
                BLL.ContractPayScheduleBySubject sch = new RmsPM.BLL.ContractPayScheduleBySubject(this.txtProjectCode.Value);
        ...
        /// 绑定动态费用明细
        /// </summary>
        private void BindDataGrid(BLL.ContractPayScheduleBySubject sch, bool IsScreenToTable)
        {
            try
            {
