						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="topic" background="../images/topic_bg.gif"><IMG height="25" src="../images/topic_li.jpg" width="35" align="absMiddle">项目管理>财务管理 
									> <span id="spanTitle" runat="server">付款一览</span></td>
							...
							<tr>
								<td id="tdList1">
									<table cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<td class="note" height="30"><asp:label Runat="server" ID="lblProjectName"></asp:label><asp:label Runat="server" ID="lblPBSName"></asp:label>工程付款一览表（元
