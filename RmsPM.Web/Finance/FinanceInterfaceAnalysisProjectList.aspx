...
{
	OpenCustomWindow("FinanceInterfaceAnalysisProjectModify.aspx?ProjectCode=" + code + "&SubjectSetCode=" + Form1.txtSubjectSetCode.value, "项目财务编码修改", 300, 180);
}
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<td class="intopic" width="200">项目财务编码</td>
