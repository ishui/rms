...
<%@ Page language="c#" Inherits="RmsPM.Web.Finance.FinanceInterfaceAnalysisUnitList" CodeFile="FinanceInterfaceAnalysisUnitList.aspx.cs" %>
...
{
	OpenCustomWindow("FinanceInterfaceAnalysisUnitModify.aspx?UnitCode=" + code + "&SubjectSetCode=" + Form1.txtSubjectSetCode.value, "部门财务编码修改", 300, 180);
}
	
function Import()
{
	OpenCustomWindow("FinanceInterfaceAnalysisUnitImport.aspx?SubjectSetCode=" + Form1.txtSubjectSetCode.value, "部门财务编码导入", 400, 280);
}
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<td class="intopic" width="200">部门财务编码</td>
									...
									<div style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 100%"><asp:datagrid id="dgList" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="15"
											...
											<Columns>
												<asp:TemplateColumn HeaderText="部门">
													<ItemTemplate>
														<a href="#" onclick="Modify(code); return false;" code='<%# DataBinder.Eval(Container, "DataItem.UnitCode") %>'>
															<%# DataBinder.Eval(Container, "DataItem.UnitFullName") %>
														</a>
													</ItemTemplate>
												</asp:TemplateColumn>
