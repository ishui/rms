	...
	public partial class PaymentDetailModify :  PageBase
	{
			...
			try
			{
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(this.up_sPMNameLower!="shidaipm")//时代要求不用合同的部门而是用发起人部门
		...
		*/
		...
		private bool CheckValid(ref string Hint, DataTable tbDtl) 
		{
            ...
            //payer=“成本批量请款”是系统定义 
            if (this.txtPayer.Value == "成本批量请款")
            {
                Hint = "普通请款单的收款人不能是“成本批量请款”";
                return false;
            }
        ...
        private void SetControlMessage(EntityData entity)
        {
            ...
            if (entity.HasRecord())
            {
                //成本批量请款时，转向成本批量请款的修改页面 xyq 2018.7.21 add
