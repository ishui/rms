<%@ Page language="c#" Inherits="RmsPM.Web.Finance.FinanceInterfaceAnalysisBuildingList" CodeFile="FinanceInterfaceAnalysisBuildingList.aspx.cs" %>
...
{
	OpenCustomWindow("FinanceInterfaceAnalysisBuildingModify.aspx?BuildingCode=" + code + "&SubjectSetCode=" + Form1.txtSubjectSetCode.value, "楼栋财务编码修改", 300, 180);
}
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<td class="intopic" width="200">楼栋财务编码</td>
									...
									<div style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 100%"><asp:datagrid id="dgList" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="15"
											...
											<Columns>
												<asp:TemplateColumn HeaderText="楼栋">
													<ItemTemplate>
														<a href="#" onclick="Modify(code); return false;" code='<%# DataBinder.Eval(Container, "DataItem.BuildingCode") %>'>
