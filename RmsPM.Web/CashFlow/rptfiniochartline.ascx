<%@ Control Language="c#" Inherits="RmsPM.Web.CashFlow.RptFinIOChartLine" CodeFile="RptFinIOChartLine.ascx.cs" %>
...
<igchart:ultrachart id="UltraChart1" ChartImagesPath="../Temp/ChartImages" JavaScriptFileName="../Images/infragistics/20051/scripts/ig_webchart.js"
	ChartType="SplineChart" EnableCrossHair="False" Transform3D-YRotation="12" Transform3D-XRotation="144"
	Transform3D-Scale="65" Transform3D-ZRotation="0" Height="420px" SplineChart-DrawStyle="Solid" SplineChart-Thickness="3"
	SplineChart-NullHandling="Zero" SplineChart-MidPointAnchors="True" SplineChart-StartStyle="DiamondAnchor"
	SplineChart-HighLightLines="False" SplineChart-SplineTension="0.3" SplineChart-EndStyle="DiamondAnchor"
	BackColor="White" Width="700px" runat="server">
	...
	<Tooltips BorderThickness="1" Overflow="None" FormatString="&lt;DATA_VALUE:0.#&gt;" EnableFadingEffect="False"
	...
	<Axis BackColor="Cornsilk">
		<Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
			...
			<Labels ItemFormatString="&lt;DATA_VALUE:0.00&gt;" VerticalAlign="Center" WrapText="False"
				FontSizeBestFit="False" SeriesFormatString="" ClipText="True" Font="Microsoft Sans Serif, 7.8pt"
				Flip="False" ItemFormat="Custom" FontColor="Black" Orientation="Horizontal" Visible="True"
		...
		<X2 LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="False" RangeMin="0" LineColor="Black"
			...
			<Labels ItemFormatString="&lt;ITEM_LABEL&gt;" VerticalAlign="Center" WrapText="False" FontSizeBestFit="False"
				...
				<SeriesLabels Font="Microsoft Sans Serif, 7.8pt" Visible="True" HorizontalAlign="Far" FontSizeBestFit="False"
					ClipText="True" FormatString="" Orientation="VerticalLeftFacing" WrapText="False" Flip="False"
					FontColor="Black" VerticalAlign="Center" OrientationAngle="0"></SeriesLabels>
			</Labels>
			<MajorGridLines AlphaLevel="255" DrawStyle="Dot" Color="Gainsboro" Visible="True" Thickness="1"></MajorGridLines>
			<MinorGridLines AlphaLevel="255" DrawStyle="Dot" Color="LightGray" Visible="False" Thickness="1"></MinorGridLines>
			<TimeAxisStyle TimeAxisStyle="Continuous"></TimeAxisStyle>
		...
		<X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
			...
			<Labels ItemFormatString="&lt;ITEM_LABEL&gt;" VerticalAlign="Near" WrapText="False" FontSizeBestFit="False"
				SeriesFormatString="" ClipText="True" Font="Microsoft Sans Serif, 7.8pt" Flip="False"
				ItemFormat="ItemLabel" FontColor="Black" Orientation="Horizontal" Visible="True" OrientationAngle="0"
				HorizontalAlign="Center">
				<SeriesLabels Font="Microsoft Sans Serif, 7.8pt" Visible="False" HorizontalAlign="Center" FontSizeBestFit="False"
					ClipText="True" FormatString="" Orientation="VerticalLeftFacing" WrapText="False" Flip="False"
					FontColor="Black" VerticalAlign="Center" OrientationAngle="0"></SeriesLabels>
			</Labels>
			<MajorGridLines AlphaLevel="255" DrawStyle="Dot" Color="Gainsboro" Visible="True" Thickness="1"></MajorGridLines>
