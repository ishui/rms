...
public partial class WorkFlowOperation_GK_OA_ArchivesCopy : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_ArchivesCopyBFL bfl = new RmsOA.BFL.GK_OA_ArchivesCopyBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
    ...
    {
        RmsOA.MODEL.GK_OA_ArchivesCopyModel manpowerneedModel = ((List<RmsOA.MODEL.GK_OA_ArchivesCopyModel>)e.ReturnValue)[0];
        this.ApplicationTitle = manpowerneedModel.FileName+"-档案借用复印审批";
