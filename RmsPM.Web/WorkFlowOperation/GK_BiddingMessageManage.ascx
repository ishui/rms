<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GK_BiddingMessageManage.ascx.cs" Inherits="WorkFlowOperation_GK_BiddingMessageManage" %>
...
<div id="EyeableDiv" runat="server">
 ...
 <table cellspacing="0" cellpadding="0" width="100%" align="center" border="1">
         <tr>
            <td class="blackbordertdcontent" nowrap style="width: 22px">
               投<Br>
               标<Br>
               内<Br>
               容<Br></td>
            <td runat=server id="tdbiddingContent" style="width:96%" class="blackbordertd" colspan="3">
               </td>
        </tr>
 </table>
