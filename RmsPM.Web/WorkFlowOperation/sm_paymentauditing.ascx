...
<div id="OperableDiv" onkeydown="if(event.keyCode==13) event.keyCode=9" runat="server">
	<table cellSpacing="0" cellPadding="0" width="100%" border="0">
		<tr>
			<td class="blackbordertd" align="right" width="15%">项目名称：&nbsp;</td>
			...
			<td class="blackbordertdpaddingcontent" width="35%">第&nbsp;<INPUT class="input" id="txtOperIssue" style="WIDTH: 50px; TEXT-ALIGN: right" type="text"
					name="txtOperIssue" runat="server"> &nbsp;期<font color="red">*</font>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td vAlign="top" colSpan="2" height="100%">
				<table id="tabOperMoney" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0"
					...
					<tr>
						<td style="border-top:gray solid" class="blackbordertd" align="right">本期应付款：&nbsp;</td>
		...
		<tr id="trOperAttachment" runat="server">
			<td colSpan="4">
				<table cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<tr>
						<td class="blackbordertd"><asp:checkbox id="chkOperAttachMent2" Runat="server" Text="2.付款证书："></asp:checkbox></td>
					...
					<tr>
						<td class="blackbordertd"><asp:checkbox id="chkOperAttachMent7" Runat="server" Text="7.其他："></asp:checkbox><asp:textbox id="txtOperOtherAttachMent" Runat="server" Width="250" CssClass="infra-input-nember"></asp:textbox></td>
		...
		<tr id="trEyeAttachment" runat="server">
			<td colSpan="4">
				<table cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<tr>
						<td class="blackbordertd"><asp:checkbox id="chkEyeAttachMent2" Runat="server" Text="2.付款证书：" Enabled="False"></asp:checkbox></td>
					...
					<tr>
						<td class="blackbordertd"><asp:checkbox id="chkEyeAttachMent7" Runat="server" Text="7.其他：" Enabled="False"></asp:checkbox><asp:textbox id="txtEyeOtherAttachMent" Runat="server"  Width="300" CssClass="infra-input-nember"
