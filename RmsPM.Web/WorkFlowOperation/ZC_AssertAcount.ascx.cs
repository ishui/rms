...
public partial class WorkFlowOperation_ZC_AssertAcount : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_CapitalAssertAcountBFL bfl = new RmsOA.BFL.GK_OA_CapitalAssertAcountBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
