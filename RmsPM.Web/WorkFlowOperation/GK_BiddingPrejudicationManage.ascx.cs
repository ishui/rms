...
public partial class WorkFlowOperation_GK_BiddingPrejudicationManage : WorkFlowOperationBase
{
    /// <summary>
    /// 业务代码
    /// </summary>
    ...
    private ModuleState _SetAttachList4;
    private ModuleState _SetAttachBiddingFile;
    ...
    public override string SubmitData()
    {
        try
        {
            ...
            if (this.State == ModuleState.Operable)
            {
                ...
                cBidding.BiddingRemark2 = this.TxtRemark.Value;
