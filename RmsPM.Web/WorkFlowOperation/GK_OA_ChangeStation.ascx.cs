...
public partial class WorkFlowOperation_GK_OA_ChangeStation : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_ChangeStationBFL bfl = new RmsOA.BFL.GK_OA_ChangeStationBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
    ...
    {
        RmsOA.MODEL.GK_OA_ChangeStationModel manpowerneedModel = ((List<RmsOA.MODEL.GK_OA_ChangeStationModel>)e.ReturnValue)[0];
        this.ApplicationTitle = manpowerneedModel.SystemCode + "员工转岗评审";
