...
public partial class WorkFlowOperation_GK_OA_ManpowerNeed : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_ManpowerNeedBFL bfl = new RmsOA.BFL.GK_OA_ManpowerNeedBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
    ...
    {
        RmsOA.MODEL.GK_OA_ManpowerNeedModel manpowerneedModel = ((List<RmsOA.MODEL.GK_OA_ManpowerNeedModel>)e.ReturnValue)[0];
        this.ApplicationTitle = manpowerneedModel.SystemCode + "人力资源需求评审";
