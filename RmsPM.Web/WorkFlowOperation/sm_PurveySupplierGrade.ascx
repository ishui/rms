<%@ Control Language="C#" AutoEventWireup="true" CodeFile="sm_PurveySupplierGrade.ascx.cs" Inherits="WorkFlowOperation_sm_PurveySupplierGrade" %>
                                                ...
                                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td style="height: 19px" >
                                                            &nbsp;产品名称：</td>
                                                        <td style="height: 19px">
                                                            <input class="input" id="TxtProductName" type="text" name="TxtProductName" runat="server">
                                                        </td>
                                                        <td>
                                                            供应商名称：</td>
                                                        <td>
