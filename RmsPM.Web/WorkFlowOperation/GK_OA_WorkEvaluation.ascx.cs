...
public partial class WorkFlowOperation_GK_OA_WorkEvaluation : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_WorkEvaluationBFL bfl = new RmsOA.BFL.GK_OA_WorkEvaluationBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
