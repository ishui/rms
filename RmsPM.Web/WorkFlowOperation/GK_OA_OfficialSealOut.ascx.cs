...
public partial class WorkFlowOperation_GK_OA_OfficialSealOut : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_OfficialSealOutBFL bfl = new RmsOA.BFL.GK_OA_OfficialSealOutBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
