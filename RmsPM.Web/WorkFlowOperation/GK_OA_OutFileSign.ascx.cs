...
public partial class WorkFlowOperation_GK_OA_OutFileSign : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_OutFileSignBFL bfl = new RmsOA.BFL.GK_OA_OutFileSignBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
    ...
    {
        RmsOA.MODEL.GK_OA_OutFileSignModel manpowerneedModel = ((List<RmsOA.MODEL.GK_OA_OutFileSignModel>)e.ReturnValue)[0];
        this.ApplicationTitle = "文件签发单审批";
        this.UnitCode = manpowerneedModel.JB_UnitCode;
    }
    /// <summary>
    /// 作废
    /// </summary>
    ...
    protected void FormView1_DataBound(object sender, EventArgs e)
    {
        if (this.FormView1.CurrentMode == FormViewMode.ReadOnly)
        {
            ...
            Label tbxUnit2 = (Label)this.FormView1.Row.FindControl("UnitLabel2");
            tbxUnit2.Text = RmsPM.BLL.SystemRule.GetUnitName(tbxUnit2.Text);
