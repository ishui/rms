...
public partial class WorkFlowOperation_SM_PaymentAuditingV2 : WorkFlowOperationBase
{
    #region --- 公共方法 ---
...
//                this.UnitCode = entity.GetString("Unit");
                ...
                this.txtOperCheckOpinion.Value = entity.GetString("CheckOpinion");
    ...
    public override string SubmitData()
    {
        try
        {
            ...
            foreach (DataRow dr in entity.CurrentTable.Select(String.Format("PaymentCode='{0}'", this.OperationCode), "", DataViewRowState.CurrentRows))
            {
                ...
                dr["CheckOpinion"] = txtOperCheckOpinion.Value;
