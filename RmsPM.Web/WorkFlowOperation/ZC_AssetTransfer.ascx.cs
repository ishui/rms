...
public partial class WorkFlowOperation_ZC_AssetTransfer : WorkFlowOperationBase
{

    private RmsOA.BFL.GK_OA_AssetTransferBFL bfl = new RmsOA.BFL.GK_OA_AssetTransferBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
