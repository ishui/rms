...
public partial class WorkFlowOperation_sm_SupplierGrade : WorkFlowOperationBase
{
    ...
    private void LoadData(bool Flag)
    {
        ...
        RmsPM.BLL.ConvertRule.GetAllTreeDataSource(dt, returndt, Gradedt, GradeMessageCode, "ConsiderDiathesisCode", "ParentCode", "", "", "", 1, 0, "","100001");
       //RmsPM.Web.temp.GetAllTreeDataSource(dt, returndt, Gradedt, GradeMessageCode, "ConsiderDiathesisCode", "ParentCode", "", "", "", 1, 0, "","100001");
