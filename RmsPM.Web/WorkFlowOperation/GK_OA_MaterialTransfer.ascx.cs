...
public partial class WorkFlowOperation_GK_OA_MaterialTransfer : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_MaterialTransferBFL bfl = new RmsOA.BFL.GK_OA_MaterialTransferBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
