...
public partial class WorkFlowOperation_sm_PurveySupplierGrade : WorkFlowOperationBase
{
    ...
    private void LoadData(bool Flag)
    {
        ...
        if (this.ApplicationCode != "")
        {
            ...
            //集团合约部总分
            TotalAgreementPoint = RmsPM.BLL.GradeList.GetGradePoint("100008", this.GradeMessageCode,"100002");
            this.lblTotalAgreement.Text = TotalAgreementPoint;
            this.OPlblTotalAgreement.Text = TotalAgreementPoint;
            ////集团技术部总分
            TotalTechnic = RmsPM.BLL.GradeList.GetGradePoint("100009", this.GradeMessageCode,"100002");
            this.lblTotalTechnic.Text = TotalTechnic;
            this.OPlblTotalTechnic.Text = TotalTechnic;
            //项目总监总分
            TotalItemMajordomo = RmsPM.BLL.GradeList.GetGradePoint("100010", this.GradeMessageCode,"100002");
            this.lblTotalItemMajordomo.Text = TotalItemMajordomo;
            this.OPlblTotalItemMajordomo.Text = TotalItemMajordomo;
            //项目合约部总分
            TotalItemAgreement = RmsPM.BLL.GradeList.GetGradePoint("100011", this.GradeMessageCode,"100002");
            this.lblTotalItemAgreement.Text = TotalItemAgreement;
            this.OPlblTotalItemAgreement.Text = TotalItemAgreement;
            //项目工程部总分
            TotalItemEngineering = RmsPM.BLL.GradeList.GetGradePoint("100012", this.GradeMessageCode,"100002");
            this.lblTotalItemEngineering.Text = TotalItemEngineering;
            this.OPlblTotalItemEngineering.Text = TotalItemEngineering;
            //项目设计部总分
            TotalItemDesign = RmsPM.BLL.GradeList.GetGradePoint("100013", this.GradeMessageCode,"100002");
            this.lblTotalItemDesign.Text = TotalItemDesign;
            this.OPlblTotalItemDesign.Text = TotalItemDesign;
            //客服部总分
            TotalClientService = RmsPM.BLL.GradeList.GetGradePoint("100014", this.GradeMessageCode,"100002");
            ...
            DataTable dtgradeDepartmentPercentage = cgradeDepartmentPercentage.GetLastDepartmentPercentage(this.GradeMessageCode, "100002");
            //调整系数 权重 汇总
            ...
            if (Dt != null)
            {
                ...
                //DataRow[] drAgreementTZ = Dt.Select("DepartmentDefineCode='100002'");
                foreach (DataRow drAgreementTZ in Dt.Select("MainDefineCode='100002'"))
                {
                    switch (drAgreementTZ["DepartmentDefineCode"].ToString())
                    {
                        ...
                        case "100008":
                            if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100008'").Length != 0)
                            {
                                if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100008'")[0]["AdjustCoefficient"] != null && System.Convert.ToString(dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100008'")[0]["AdjustCoefficient"]) != "")
                                    drAgreementTZ["AdjustCoefficient"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100008'")[0]["AdjustCoefficient"];
                                drAgreementTZ["Percentage"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100008'")[0]["Percentage"];
                            }
                            ...
                            break;
                        case "100009":
                            if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100009'").Length != 0)
                            {
                                if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100009'")[0]["AdjustCoefficient"] != null && System.Convert.ToString(dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100009'")[0]["AdjustCoefficient"]) != "")
                                    drAgreementTZ["AdjustCoefficient"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100009'")[0]["AdjustCoefficient"];
                                drAgreementTZ["Percentage"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100009'")[0]["Percentage"];
                            }
                            ...
                            break;
                        case "100010":
                            if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100010'").Length != 0)
                            {
                                if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100010'")[0]["AdjustCoefficient"] != null && System.Convert.ToString(dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100010'")[0]["AdjustCoefficient"]) != "")
                                    drAgreementTZ["AdjustCoefficient"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100010'")[0]["AdjustCoefficient"];
                                drAgreementTZ["Percentage"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100010'")[0]["Percentage"];
                            }
                            ...
                            break;
                        case "100011":
                            if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100011'").Length != 0)
                            {
                                if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100011'")[0]["AdjustCoefficient"] != null && System.Convert.ToString(dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100011'")[0]["AdjustCoefficient"]) != "")
                                    drAgreementTZ["AdjustCoefficient"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100011'")[0]["AdjustCoefficient"];
                                drAgreementTZ["Percentage"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100011'")[0]["Percentage"];
                            }
                            ...
                            break;
                        case "100012":
                            if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100012'").Length != 0)
                            {
                                if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100012'")[0]["AdjustCoefficient"] != null && System.Convert.ToString(dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100012'")[0]["AdjustCoefficient"]) != "")
                                    drAgreementTZ["AdjustCoefficient"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100012'")[0]["AdjustCoefficient"];
                                drAgreementTZ["Percentage"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100012'")[0]["Percentage"];
                            }
                        ...
                        case "100013":
                            if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100013'").Length != 0)
                            {
                                if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100013'")[0]["AdjustCoefficient"] != null && System.Convert.ToString(dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100013'")[0]["AdjustCoefficient"]) != "")
                                    drAgreementTZ["AdjustCoefficient"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100013'")[0]["AdjustCoefficient"];
                                drAgreementTZ["Percentage"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100013'")[0]["Percentage"];
                            }
                            ...
                            break;
                        case "100014":
                            if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100014'").Length != 0)
                            {
                                if (dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100014'")[0]["AdjustCoefficient"] != null && System.Convert.ToString(dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100014'")[0]["AdjustCoefficient"]) != "")
                                    drAgreementTZ["AdjustCoefficient"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100014'")[0]["AdjustCoefficient"];
                                drAgreementTZ["Percentage"] = (decimal)dtgradeDepartmentPercentage.Select("DepartmentDefineCode='100014'")[0]["Percentage"];
                            }
            ...
            this.TxtProductName.Value = gm.ProduceName;
            this.lblProductName.Text = gm.ProduceName;
        ...
        {
            DataTable dtgradeConsiderPercentage = cgradeConsiderPercentage.GetLastConsiderPercentage(this.GradeMessageCode, "100002");
        ...
        RmsPM.BLL.ConvertRule.GetAllTreeDataSource(dt, returndt, Gradedt, GradeMessageCode, "ConsiderDiathesisCode", "ParentCode", "", "", "", 1, 0, "", "100002");
        //RmsPM.Web.temp.GetAllTreeDataSource(dt, returndt, Gradedt, GradeMessageCode, "ConsiderDiathesisCode", "ParentCode", "", "", "", 1, 0, "","100002");
            ...
            try
            {
                ...
                if (this.State == ModuleState.Operable)
                {
                    if (this.GradeMessageCode != "")
                    {
                        ...
                        gm.ProduceName = this.TxtProductName.Value;
                        gm.GradeMessageUpdate();
                    }
                    else
                    {
                        gm.GradeMessageCode = "";
                        gm.MainDefineCode = "100002";
            ...
            try
            {
                ...
                if (this.State == ModuleState.Operable)
                {
                    ...
                    else
                    {
                        ...
                        this.ApplicationTitle = txtSupplierName.Value;
                        this.UnitCode = "";
                ...
                DataTable dtgradeConsiderPercentage = this.GetLastConsiderPercentage(this.GradeMessageCode, "100002");
                ...
                for (int i = 0; i < Repeater1.Items.Count; i++)
                {
                    if (((Label)Repeater1.Items[i].FindControl("Labelsubtotal")).Text == "1")
                    {
                        ...
                        if (dtgradeConsiderPercentage != null && dtgradeConsiderPercentage.Rows.Count != 0)
                        {
                            if (dtgradeConsiderPercentage.Select("MainDefineCode='100002' and ConsiderDiathesisCode='" + ((Label)Repeater1.Items[i].FindControl("LabelCode")).Text + "'").Length != 0)
                                cgradeConsiderPercentage.ConsiderPercentageCode = dtgradeConsiderPercentage.Select("MainDefineCode='100002' and ConsiderDiathesisCode='" + ((Label)Repeater1.Items[i].FindControl("LabelCode")).Text + "'")[0]["ConsiderPercentageCode"].ToString();
                        ...
                        else
                        {
                            if (this.StatePersentage == ModuleState.Operable)
                            {
                                ...
                                cgradeConsiderPercentage.MainDefineCode = "100002";
                    ...
                    if (((Label)Repeater1.Items[i].FindControl("LabelFlag")).Text == "1")
                    {
                        ...
                        else
                        {
                            ...
                            gv.GradeCode = "";
                            gv.DepartmentDefineCode = "100008";
                            ...
                            //gv.GradeMessageCode = gm.GradeMessageCode;
                            gv.GradeCode = "";
                            gv.DepartmentDefineCode = "100009";
                            gv.ConsiderDiathesisCode = ((Label)Repeater1.Items[i].FindControl("LabelCode")).Text;
                            gv.GradeValue = System.Convert.ToInt32(((TextBox)Repeater1.Items[i].FindControl("txtTechnic")).Text.Trim());
                            gv.GradeSubmit();
                            ...
                            //gv.GradeMessageCode = gm.GradeMessageCode;
                            gv.GradeCode = "";
                            gv.DepartmentDefineCode = "100010";
                            gv.ConsiderDiathesisCode = ((Label)Repeater1.Items[i].FindControl("LabelCode")).Text;
                            gv.GradeValue = System.Convert.ToInt32(((TextBox)Repeater1.Items[i].FindControl("txtItemMajordomo")).Text.Trim());
                            gv.GradeSubmit();
                            ...
                            //gv.GradeMessageCode = gm.GradeMessageCode;
                            gv.GradeCode = "";
                            gv.DepartmentDefineCode = "100011";
                            gv.ConsiderDiathesisCode = ((Label)Repeater1.Items[i].FindControl("LabelCode")).Text;
                            gv.GradeValue = System.Convert.ToInt32(((TextBox)Repeater1.Items[i].FindControl("txtItemAgreement")).Text.Trim());
                            gv.GradeSubmit();
                            ...
                            //gv.GradeMessageCode = gm.GradeMessageCode;
                            gv.GradeCode = "";
                            gv.DepartmentDefineCode = "100012";
                            gv.ConsiderDiathesisCode = ((Label)Repeater1.Items[i].FindControl("LabelCode")).Text;
                            gv.GradeValue = System.Convert.ToInt32(((TextBox)Repeater1.Items[i].FindControl("txtItemEngineering")).Text.Trim());
                            gv.GradeSubmit();
                            ...
                            //gv.GradeMessageCode = gm.GradeMessageCode;
                            gv.GradeCode = "";
                            gv.DepartmentDefineCode = "100013";
                            gv.ConsiderDiathesisCode = ((Label)Repeater1.Items[i].FindControl("LabelCode")).Text;
                            gv.GradeValue = System.Convert.ToInt32(((TextBox)Repeater1.Items[i].FindControl("txtItemDesign")).Text.Trim());
                            gv.GradeSubmit();
                            ...
                            //gv.GradeMessageCode = gm.GradeMessageCode;
                            gv.GradeCode = "";
                            gv.DepartmentDefineCode = "100014";
                            gv.ConsiderDiathesisCode = ((Label)Repeater1.Items[i].FindControl("LabelCode")).Text;
                            gv.GradeValue = System.Convert.ToInt32(((TextBox)Repeater1.Items[i].FindControl("txtClientService")).Text.Trim());
                            gv.GradeSubmit();
                ...
                {
                    foreach (DataRow drAgreementTZ in Dtdepartment.Select("MainDefineCode='100002'"))
                    {
                        if (dtgradeDepartmentPercentage != null && dtgradeDepartmentPercentage.Rows.Count != 0)
                        {

                            if (dtgradeDepartmentPercentage.Select("MainDefineCode='100002' and DepartmentDefineCode='" + System.Convert.ToString(drAgreementTZ["DepartmentDefineCode"]) + "'").Length != 0)
                            {

                                cgradeDepartmentPercentage.DepartmentPercentageCode = dtgradeDepartmentPercentage.Select("MainDefineCode='100002' and DepartmentDefineCode='" + System.Convert.ToString(drAgreementTZ["DepartmentDefineCode"]) + "'")[0]["DepartmentPercentageCode"].ToString();
                            }

                            if (this.StatePersentage == ModuleState.Operable)
                            {
                                cgradeDepartmentPercentage.dao = dao;
                                cgradeDepartmentPercentage.AdjustCoefficient = System.Convert.ToDecimal(cgradeConsiderDepartment.GetAdjustCoefficient(System.Convert.ToString(drAgreementTZ["DepartmentDefineCode"]), this.GradeMessageCode,"100002"));
                        ...
                        else
                        {
                            ...
                            cgradeDepartmentPercentage.MainDefineCode = "100002";
                            cgradeDepartmentPercentage.AdjustCoefficient = System.Convert.ToDecimal(cgradeConsiderDepartment.GetAdjustCoefficient(System.Convert.ToString(drAgreementTZ["DepartmentDefineCode"]), this.GradeMessageCode,"100002"));
                            cgradeDepartmentPercentage.Percentage = System.Convert.ToDecimal(drAgreementTZ["Percentage"]);
