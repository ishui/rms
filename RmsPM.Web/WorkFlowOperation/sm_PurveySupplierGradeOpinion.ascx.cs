...
public partial class WorkFlowOperation_sm_PurveySupplierGradeOpinion : WorkFlowOperationBase
{
    ...
    private void LoadData(bool Flag)
    {
        ...
        if (this.ApplicationCode != "")
        {
            ...
            if (Dt != null)
            {
                ...
                this.lblProduceName.Text = gm.ProduceName;
            ...
            RmsPM.BLL.ConvertRule.GetSHTreeDataSource(dt, returndt, GradeMessageCode, "ConsiderDiathesisCode", "ParentCode", "", "", "", 1, 0, "","100002");
