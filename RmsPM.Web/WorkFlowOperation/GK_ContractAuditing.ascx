<%@ Control Language="c#" Inherits="WorkFlowOperation_GK_ContractAuditing" CodeFile="GK_ContractAuditing.ascx.cs" %>
	...
	<table cellSpacing="0" cellPadding="0" width="100%" border="0">
		...
		<tr>
			...
			<td class="blackbordertdpaddingcontent">
				<INPUT class="input" id="txtOperContractName" type="text" size="32" name="txtOperContractName"
		...
		<tr>
			<td class="blackbordertd" align="right">签约单位（分包）：&nbsp;</td>
			<td class="blackbordertdpaddingcontent">
		...
		<tr>
			<td class="blackbordertd" align="right">签约单位（总包）：&nbsp;</td>
			<td class="blackbordertdpaddingcontent">
			...
			<td class="blackbordertdpaddingcontent"><input class="input" id="txtOperBuilding" type="text" name="txtOperBuilding" runat="server" /></td>
		</tr>
		<tr>
...
<div id="EyeableDiv" runat="server">
	<table cellSpacing="0" cellPadding="0" width="100%" border="0">
		...
		<tr>
			<td class="blackbordertd" align="right">签约单位（分保）：&nbsp;</td>
			<td class="blackbordertdpaddingcontent">
