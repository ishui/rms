...
public partial class WorkFlowOperation_GK_OA_FileChange : WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_FileChangeBFL bfl = new RmsOA.BFL.GK_OA_FileChangeBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
    ...
    {
        RmsOA.MODEL.GK_OA_FileChangeModel manpowerneedModel = ((List<RmsOA.MODEL.GK_OA_FileChangeModel>)e.ReturnValue)[0];
        this.ApplicationTitle = "文件更改审批";
