...
public partial class WorkFlowOperation_GK_OA_ChangeStationNotice: WorkFlowOperationBase
{
    private RmsOA.BFL.GK_OA_ChangeStationNoticeBFL bfl = new RmsOA.BFL.GK_OA_ChangeStationNoticeBFL();
    /// <summary>
    /// 装载控件数据
    /// </summary>
    ...
    {
        RmsOA.MODEL.GK_OA_ChangeStationNoticeModel manpowerneedModel = ((List<RmsOA.MODEL.GK_OA_ChangeStationNoticeModel>)e.ReturnValue)[0];
        this.ApplicationTitle = manpowerneedModel.SystemCode + "员工转岗通知评审";
        this.UnitCode = manpowerneedModel.OldUnitCode;
