<%@ Page language="c#" Inherits="RmsPM.Web.Systems.WBSProportionConfig" CodeFile="WBSProportionConfig.aspx.cs" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="white"
				id="Table1">
				<tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">工作权重开关</td>
				</tr>
				<tr>
