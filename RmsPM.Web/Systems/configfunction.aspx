<%@ Page language="c#" Inherits="RmsPM.Web.Systems.ConfigFunction" CodeFile="ConfigFunction.aspx.cs" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="#ffffff">
				<tr>
					<td class="topic" align="center" background="../images/topic_bg.gif" height="25">配置功能树</td>
				</tr>
				<tr>
					<td vAlign="top">
						<asp:DataList id="dtlMainFunction" runat="server" RepeatDirection="Horizontal" HorizontalAlign="Left"
							...
							<ItemTemplate>
								<a href='ConfigFunction.aspx?MainCode=<%# DataBinder.Eval(Container.DataItem, "FunctionStructureCode") %>' >
