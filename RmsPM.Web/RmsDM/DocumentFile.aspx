<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentFile.aspx.cs" Inherits="WorkFlowPage_DocumentFile" %>

<%@ Register Src="DocumentFile.ascx" TagName="DocumentFile"  TagPrefix="uc2" %>
						...
						<table class="blackbordertable" cellspacing="0" cellpadding="0" width="100%" border="0">
							...
							<tr>
								<td colspan="2" class="blackbordertd">									
                                    <uc2:DocumentFile ID="ucOperationControl" runat="server" />
								</td>
							</tr>
							<tr>
