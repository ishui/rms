<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileTemplate.aspx.cs" Inherits="RmsDM_FileTemplate" %>
				...
				<tr>
					<td height="25">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="topic" background="../images/topic_bg.gif"><IMG height="25" src="../images/topic_li.jpg" width="35" align="absMiddle">数据资料>文模板管理
								</td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
							<tr>
								...
								<TD vAlign="top" align="left">
									<iframe id="frameMain" name="frameMain" src='FileTemplatelist.aspx' width="100%"
