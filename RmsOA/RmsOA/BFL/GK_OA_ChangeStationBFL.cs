namespace RmsOA.BFL
{
    ...
    public class GK_OA_ChangeStationBFL
    {
        public int Delete(GK_OA_ChangeStationModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_ChangeStationBLL().Delete(ObjModel.Code, transaction);
                        transaction.Commit();
                    }
        ...
        public GK_OA_ChangeStationModel GetGK_OA_ChangeStation(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                {
                    connection.Open();
                    model = new GK_OA_ChangeStationBLL().GetModel(Code, connection);
                    connection.Close();
                }
                catch (SqlException exception)
                {
        ...
        public List<GK_OA_ChangeStationModel> GetGK_OA_ChangeStationListOne(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                {
                    connection.Open();
                    GK_OA_ChangeStationBLL nbll = new GK_OA_ChangeStationBLL();
        ...
        public int Insert(GK_OA_ChangeStationModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_ChangeStationBLL().Insert(ObjModel, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyAlreadyAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_ChangeStationBLL().ModifyAlreadyAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyBankOutAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_ChangeStationBLL().ModifyBankOutAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyNotAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_ChangeStationBLL().ModifyNotAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyNotPassAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_ChangeStationBLL().ModifyNotPassAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyPassAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_ChangeStationBLL().ModifyPassAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int Update(GK_OA_ChangeStationModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_ChangeStationBLL().Update(ObjModel, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
