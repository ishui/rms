namespace RmsOA.BFL
{
    ...
    public class YF_AssetMainApplyBFL
    {
        public int Delete(YF_AssetMainApplyModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new YF_AssetMainApplyBLL().Delete(ObjModel.Code, transaction);
                        transaction.Commit();
                    }
        ...
        public int Insert(YF_AssetMainApplyModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new YF_AssetMainApplyBLL().Insert(ObjModel, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyAlreadyAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new YF_AssetMainApplyBLL().ModifyAlreadyAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyBankOutAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new YF_AssetMainApplyBLL().ModifyBankOutAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyNotAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new YF_AssetMainApplyBLL().ModifyNotAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyPassAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new YF_AssetMainApplyBLL().ModifyPassAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
