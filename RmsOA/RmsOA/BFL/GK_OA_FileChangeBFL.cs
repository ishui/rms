namespace RmsOA.BFL
{
    ...
    public class GK_OA_FileChangeBFL
    {
        public int Delete(GK_OA_FileChangeModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_FileChangeBLL().Delete(ObjModel.Code, transaction);
                        transaction.Commit();
                    }
        ...
        public int Insert(GK_OA_FileChangeModel ObjModel)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_FileChangeBLL().Insert(ObjModel, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyAlreadyAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_FileChangeBLL().ModifyAlreadyAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyBankOutAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_FileChangeBLL().ModifyBankOutAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyNotAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_FileChangeBLL().ModifyNotAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
        ...
        public int ModifyPassAuditing(int Code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(FunctionRule.GetConnectionString()))
            {
                ...
                try
                {
                    try
                    {
                        num = new GK_OA_FileChangeBLL().ModifyPassAuditing(Code, transaction);
                        transaction.Commit();
                    }
                    catch (SqlException exception)
                    {
