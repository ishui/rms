namespace RmsPM.DAL.CommonWorkFlowDAL
{
    ...
    public class TC_OA_PurchasePriceDAL
    {
        private SqlDataProcess _DataProcess;

        public TC_OA_PurchasePriceDAL(SqlConnection Connection)
        {
            this._DataProcess = new SqlDataProcess(Connection);
        }

        public TC_OA_PurchasePriceDAL(SqlTransaction Transaction)
        {
            this._DataProcess = new SqlDataProcess(Transaction);
        }

        private TC_OA_PurchasePriceModel _DataBind(int Code)
        {
            TC_OA_PurchasePriceModel model = new TC_OA_PurchasePriceModel();
            StringBuilder builder = new StringBuilder();
            builder.Append("select * from TC_OA_PurchasePrice ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from TC_OA_PurchasePrice ");
            builder.Append(" where Code=@Code");
            this._DataProcess.CommandText = builder.ToString();
            this._DataProcess.ProcessParametersAdd("@Code", SqlDbType.Int, 4, Code);
        ...
        private int _Insert(TC_OA_PurchasePriceModel mObj)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("insert into TC_OA_PurchasePrice(");
            builder.Append("UserCode,UnitCode,ApplayDate,Name,UseWay,Type,Suggest,Auditing)");
        ...
        private List<TC_OA_PurchasePriceModel> _Select(TC_OA_PurchasePriceQueryModel qmObj)
        {
        ...
        private int _Update(TC_OA_PurchasePriceModel mObj)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update TC_OA_PurchasePrice set ");
        ...
        public int Delete(TC_OA_PurchasePriceModel mObj)
        {
            return this._Delete(mObj.Code);
        }

        public TC_OA_PurchasePriceModel GetModel(int Code)
        {
            return this._DataBind(Code);
        }

        private void Initialize(SqlDataReader reader, TC_OA_PurchasePriceModel obj)
        {
            ...
            {
                obj.Suggest = reader.GetString(7);
            }
        ...
        public int Insert(TC_OA_PurchasePriceModel mObj)
        {
            return this._Insert(mObj);
        }

        public List<TC_OA_PurchasePriceModel> Select()
        {
            TC_OA_PurchasePriceQueryModel qmObj = new TC_OA_PurchasePriceQueryModel();
            return this._Select(qmObj);
        }

        public List<TC_OA_PurchasePriceModel> Select(TC_OA_PurchasePriceQueryModel qmObj)
        {
            return this._Select(qmObj);
        }

        public int Update(TC_OA_PurchasePriceModel mObj)
        {
