namespace RmsPM.DAL.CommonWorkFlowDAL
{
    ...
    public class TC_OA_SmallGoodsDAL
    {
        private SqlDataProcess _DataProcess;

        public TC_OA_SmallGoodsDAL(SqlConnection Connection)
        {
            this._DataProcess = new SqlDataProcess(Connection);
        }

        public TC_OA_SmallGoodsDAL(SqlTransaction Transaction)
        {
            this._DataProcess = new SqlDataProcess(Transaction);
        }

        private TC_OA_SmallGoodsModel _DataBind(int Code)
        {
            TC_OA_SmallGoodsModel model = new TC_OA_SmallGoodsModel();
            StringBuilder builder = new StringBuilder();
            builder.Append("select * from TC_OA_SmallGoods ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from TC_OA_SmallGoods ");
            builder.Append(" where Code=@Code");
            this._DataProcess.CommandText = builder.ToString();
            this._DataProcess.ProcessParametersAdd("@Code", SqlDbType.Int, 4, Code);
        ...
        private int _Insert(TC_OA_SmallGoodsModel mObj)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("insert into TC_OA_SmallGoods(");
        ...
        private List<TC_OA_SmallGoodsModel> _Select(TC_OA_SmallGoodsQueryModel qmObj)
        {
        ...
        private int _Update(TC_OA_SmallGoodsModel mObj)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update TC_OA_SmallGoods set ");
        ...
        public int Delete(TC_OA_SmallGoodsModel mObj)
        {
            return this._Delete(mObj.Code);
        }

        public TC_OA_SmallGoodsModel GetModel(int Code)
        {
            return this._DataBind(Code);
        }

        private void Initialize(SqlDataReader reader, TC_OA_SmallGoodsModel obj)
        {
        ...
        public int Insert(TC_OA_SmallGoodsModel mObj)
        {
            return this._Insert(mObj);
        }

        public List<TC_OA_SmallGoodsModel> Select()
        {
            TC_OA_SmallGoodsQueryModel qmObj = new TC_OA_SmallGoodsQueryModel();
            return this._Select(qmObj);
        }

        public List<TC_OA_SmallGoodsModel> Select(TC_OA_SmallGoodsQueryModel qmObj)
        {
            return this._Select(qmObj);
        }

        public int Update(TC_OA_SmallGoodsModel mObj)
        {
