namespace RmsPM.DAL.CommonWorkFlowDAL
{
    ...
    public class TC_OA_BigGoodsDetailDAL
    {
        private SqlDataProcess _DataProcess;

        public TC_OA_BigGoodsDetailDAL(SqlConnection Connection)
        {
            this._DataProcess = new SqlDataProcess(Connection);
        }

        public TC_OA_BigGoodsDetailDAL(SqlTransaction Transaction)
        {
            this._DataProcess = new SqlDataProcess(Transaction);
        }

        private TC_OA_BigGoodsDetailModel _DataBind(int Code)
        {
            TC_OA_BigGoodsDetailModel model = new TC_OA_BigGoodsDetailModel();
            StringBuilder builder = new StringBuilder();
            builder.Append("select * from TC_OA_BigGoodsDetail ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from TC_OA_BigGoodsDetail ");
            builder.Append(" where Code=@Code");
            this._DataProcess.CommandText = builder.ToString();
            this._DataProcess.ProcessParametersAdd("@Code", SqlDbType.Int, 4, Code);
        ...
        private int _Insert(TC_OA_BigGoodsDetailModel mObj)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("insert into TC_OA_BigGoodsDetail(");
        ...
        private List<TC_OA_BigGoodsDetailModel> _Select(TC_OA_BigGoodsDetailQueryModel qmObj)
        {
        ...
        private int _Update(TC_OA_BigGoodsDetailModel mObj)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update TC_OA_BigGoodsDetail set ");
        ...
        public int Delete(TC_OA_BigGoodsDetailModel mObj)
        {
            return this._Delete(mObj.Code);
        }

        public TC_OA_BigGoodsDetailModel GetModel(int Code)
        {
            return this._DataBind(Code);
        }

        private void Initialize(SqlDataReader reader, TC_OA_BigGoodsDetailModel obj)
        {
        ...
        public int Insert(TC_OA_BigGoodsDetailModel mObj)
        {
            return this._Insert(mObj);
        }

        public List<TC_OA_BigGoodsDetailModel> Select()
        {
            TC_OA_BigGoodsDetailQueryModel qmObj = new TC_OA_BigGoodsDetailQueryModel();
            return this._Select(qmObj);
        }

        public List<TC_OA_BigGoodsDetailModel> Select(TC_OA_BigGoodsDetailQueryModel qmObj)
        {
            return this._Select(qmObj);
        }

        public int Update(TC_OA_BigGoodsDetailModel mObj)
        {
